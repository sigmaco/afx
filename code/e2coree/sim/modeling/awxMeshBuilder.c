...
_AFX awxMesh AfxBuildCubeMesh(awxSimulation sim, afxReal scale)
{
    afxError err = NIL;
...
_AFX awxMesh AfxBuildParallelepipedMesh(awxSimulation sim, afxReal width, afxReal height)
{
    afxError err = NIL;
    AfxAssertObjects(1, &sim, afxFcc_SIM);
    AfxAssert(width);
...
_AFX awxMesh AfxBuildDomeMesh(awxSimulation sim, afxReal radius, afxNat slices)
{
    afxError err = NIL;
    AfxAssertObjects(1, &sim, afxFcc_SIM);
    AfxAssert(radius);
