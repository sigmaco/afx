...
_AFXINL void AfxUpdateVertexPositions(afxMeshBuilder* mshb, afxNat baseVtxIdx, afxNat vtxCnt, afxReal const posn[][3])
{
    afxError err = NIL;
    AfxAssertType(mshb, afxFcc_MSHB);
    AfxAssertRange(mshb->vtxCnt, baseVtxIdx, vtxCnt);
...
_AFXINL afxError AfxUpdateVertexNormals(afxMeshBuilder* mshb, afxNat baseVtxIdx, afxNat vtxCnt, afxReal const nrm[][3])
{
    afxError err = NIL;
    AfxAssertType(mshb, afxFcc_MSHB);
    AfxAssertRange(mshb->vtxCnt, baseVtxIdx, vtxCnt);
...
_AFXINL afxError AfxUpdateVertexWraps(afxMeshBuilder* mshb, afxNat baseVtxIdx, afxNat vtxCnt, afxReal const uv[][2])
{
    afxError err = NIL;
    AfxAssertType(mshb, afxFcc_MSHB);
    AfxAssertRange(mshb->vtxCnt, baseVtxIdx, vtxCnt);
