...
AFX void                AfxGetMeshPrimitives(afxMeshTopology msht, afxNat surfIdx, afxNat* baseTriIdx, afxNat* triCnt);

AFX void                AfxSetMeshCoverage(afxMeshTopology msht, afxNat surfIdx, afxNat mtlIdx);
AFX afxBool             AfxGetMeshCoverage(afxMeshTopology msht, afxNat surfIdx, afxNat* mtlIdx);
