...
AFX afxInstanceFlag       AfxObjectSetFlags(afxObject obj, afxInstanceFlag flags);
AFX afxInstanceFlag       AfxObjectClearFlags(afxObject obj, afxInstanceFlag flags);
AFX afxBool             AfxObjectTestFlags(afxObject obj, afxInstanceFlag flags);
