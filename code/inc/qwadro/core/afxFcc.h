...
typedef enum afxFcc
{
    ...
    afxFcc_SVC      = AfxPackFcc('s', 'v', 'c', '\0'), // afxService
    ...
    afxFcc_MMU      = AfxPackFcc('m', 'm', 'u', '\0'), // afxMmu
    afxFcc_MPAG     = AfxPackFcc('m', 'p', 'a', 'g'), // afxMemPage
    //afxFcc_CHNK     = AfxPackFcc('m', 'e', 'm', '\0'), // afxMmu
    ...
    afxFcc_TXU      = AfxPackFcc('t', 'x', 'u', '\0'), // afxTxu
    ...
    afxFcc_WID      = AfxPackFcc('w', 'i', 'd', '\0'), // auxWidget
    afxFcc_WND      = AfxPackFcc('w', 'n', 'd', '\0'), // afxWindow
    afxFcc_WPP      = AfxPackFcc('w', 'p', 'p', '\0'), // afxWallpaper
    afxFcc_TYP      = AfxPackFcc('t', 'y', 'p', '\0'), // afxTypography
    ...
    afxFcc_SSYS     = AfxPackFcc('s', 's', 'y', 's'), // aaxSoundSystem
    afxFcc_SDEV     = AfxPackFcc('s', 'o', 'u', 't'), // aaxSoundIoDevice
    afxFcc_SOUT     = AfxPackFcc('s', 'o', 'u', 't'), // aaxSoundOutput
    afxFcc_SIN      = AfxPackFcc('s', 'i', 'n', '\0'), // aaxSoundInput
    afxFcc_SCTX     = AfxPackFcc('s', 'c', 't', 'x'), // aaxSoundContext
    ...
    afxFcc_SIM      = AfxPackFcc('s', 'i', 'm', '\0'), // awxSimulation
    afxFcc_HUB      = AfxPackFcc('h', 'u', 'b', '\0'), // afxHub
    afxFcc_DAG      = AfxPackFcc('d', 'a', 'g', '\0'), // afxDag
    afxFcc_NOD      = AfxPackFcc('n', 'o', 'd', '\0'), // awxNode
    afxFcc_NODA     = AfxPackFcc('n', 'o', 'd', 'a'), // awxNodeAnnex (node annex)
    afxFcc_ASIO     = AfxPackFcc('a', 's', 'i', 'o'), // awxAssetIoAssistent
    afxFcc_PVT      = AfxPackFcc('p', 'v', 't', '\0'), // awxNode
    ...
    afxFcc_ENT      = AfxPackFcc('e', 'n', 't', '\0'), // awxEntity
    afxFcc_ASP      = AfxPackFcc('a', 's', 'p', '\0'), // afxAspect
    afxFcc_LIT      = AfxPackFcc('l', 'i', 't', '\0'), // awxLight
    afxFcc_CAM      = AfxPackFcc('c', 'a', 'm', '\0'), // afxCamera
    afxFcc_SKY      = AfxPackFcc('s', 'k', 'y', '\0'), // awxSky
    ...
    afxFcc_RND      = AfxPackFcc('r', 'n', 'd', '\0'), // awxRenderer
