...
AFX afxError    AfxAcquireDirectionalLights(awxSimulation sim, afxNat cnt, afxNat uid[]);
AFX afxError    AfxAcquireOmniLights(awxSimulation sim, afxNat cnt, afxNat uid[]);
AFX afxError    AfxAcquireSpotLights(awxSimulation sim, afxNat cnt, afxNat uid[]);
