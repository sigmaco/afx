...
AFX afxError AwxAcquireRenderers(awxSimulation sim, afxNat cnt, awxRenderer rnd[], awxRendererConfig const config[]);


AFX void    AwxCmdRequestModel(awxSimulation sim, afxNat id);
