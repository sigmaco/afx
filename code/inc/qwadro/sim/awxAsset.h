...
#include "qwadro/core/afxSource.h"
...
AFX afxError            AfxAcquireAssets(awxSimulation sim, afxNat cnt, afxNat const nestCnt[], afxNat const resCap[], awxAsset cad[]);
AFX afxError            AfxBuildAssets(awxSimulation sim, awxAssetBuilder const* cadb, afxNat cnt, void* data[], awxAsset cad[]);

AFX afxError            AfxLoadAssets(awxSimulation sim, afxError(*load)(afxUri const* file, afxFlags flags), afxFlags flags, afxNat cnt, afxUri const file[]);
AFX afxError            AfxStoreAssets(awxSimulation sim, afxError(*store)(afxUri const* file, afxFlags flags), afxFlags flags, afxNat cnt, afxUri const file[]);
