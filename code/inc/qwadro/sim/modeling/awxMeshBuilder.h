...
AFX awxMesh             AfxBuildCubeMesh(awxSimulation sim, afxReal scale);
AFX awxMesh             AfxBuildParallelepipedMesh(awxSimulation sim, afxReal width, afxReal height);
AFX awxMesh             AfxBuildDomeMesh(awxSimulation sim, afxReal radius, afxNat slices);
