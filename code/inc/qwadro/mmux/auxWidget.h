...
AFX_DEFINE_STRUCT( auxWidgetStyle)
{
    afxRect     rect;
};
...
AFX_DEFINE_STRUCT( auxWidgetVertex)
{
    afxV2d      xy, uv;
};

AFX_DECLARE_STRUCT(auxWidgetImplementation);
AFX_DECLARE_STRUCT(auxWidgetImplementationData);

AFX_DEFINE_STRUCT(auxWidgetConfig)
{
    afxString const *name;
    auxWidget parent;
    afxUri const *uri;
    afxResult(*f)(auxWidget, afxUri const*, void *data);
};

#ifdef _AFX_WIDGET_C
AFX_OBJECT(auxWidget)
{
    afxLinkage                      parent;
    afxChain                        children;
    ...
    afxResult                       (*update)(auxWidget wid, afxReal dt);

    auxWidgetImplementation const   *impl;
    auxWidgetImplementationData     *data;
