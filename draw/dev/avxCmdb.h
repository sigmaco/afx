...
/// AfxAcquireBatches can be used to allocate multiple command buffers.
...
AVX afxError    AfxAcquireBatches(afxDrawContext dctx, afxNat portId, afxNat cnt, avxCmdb batches[]);
