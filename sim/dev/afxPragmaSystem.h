...
#ifndef AMX_PRAGMA_SYSTEM_H
#define AMX_PRAGMA_SYSTEM_H

#include "qwadro/draw/dev/afxDrawSystem.h"

#include "qwadro/sim/dev/afxPragmaBridge.h"

#include "qwadro/sim/afxAnimation.h"
#include "qwadro/sim/afxMotor.h"
#include "qwadro/sim/afxMotion.h"

#include "qwadro/sim/rendering/akxLighting.h"
#include "qwadro/sim/rendering/akxRenderer.h"

AFX_DEFINE_STRUCT(afxPragmaDeviceCaps)
{
    afxBool8    work;
    afxBool8    curves;
    afxBool8    bsplines;
...
AFX_DEFINE_STRUCT(afxPragmaDeviceLimits)
{
    afxNat nat;
};
...
AMX afxClass const* AfxGetPragmaDeviceClass(void);

// MATH DEVICE DISCOVERY ///////////////////////////////////////////////////////

AMX afxNat          AfxInvokePragmaDevices(afxNat first, afxNat cnt, afxBool(*f)(afxPragmaDevice, void*), void* udd);
AMX afxNat          AfxEvokePragmaDevices(afxBool(*flt)(afxPragmaDevice, void*), void* fdd, afxNat first, afxNat cnt, afxPragmaDevice devices[]);
AMX afxNat          AfxEnumeratePragmaDevices(afxNat first, afxNat cnt, afxPragmaDevice devices[]);

AMX afxBool         AfxGetPragmaDevice(afxNat mdevId, afxPragmaDevice* device);

// MATH DEVICE HANDLING ////////////////////////////////////////////////////////

AMX afxNat          AfxInvokeSimulations(afxPragmaDevice mdev, afxNat first, afxNat cnt, afxBool(*f)(afxSimulation, void*), void *udd);
AMX afxNat          AfxEvokeSimulations(afxPragmaDevice mdev, afxBool(*flt)(afxSimulation, void*), void* fdd, afxNat first, afxNat cnt, afxSimulation simulations[]);
AMX afxNat          AfxEnumerateSimulations(afxPragmaDevice mdev, afxNat first, afxNat cnt, afxSimulation simulations[]);

AMX afxClass const* AfxGetSimulationClass(afxPragmaDevice mdev);

AMX afxNat          AfxCountPragmaPorts(afxPragmaDevice mdev);

AMX afxBool         AfxIsPragmaDevicePrompt(afxPragmaDevice mdev);
