...
_ASX afxError _AsxSinCtorCb(afxSoundInput sin, void** args, afxNat invokeNo)
{
    afxError err = AFX_ERR_NONE;
    AfxAssertObjects(1, &sin, afxFcc_SIN);
...
_ASX afxError AfxConfigureSoundInput(afxNat sdevId, afxSoundInputConfig* cfg)
{
    afxError err = AFX_ERR_NONE;
...
_ASX afxError AfxOpenSoundInput(afxNat sdevId, afxSoundInputConfig const* cfg, afxSoundInput* input)
{
    afxError err = AFX_ERR_NONE;
    afxSoundDevice sdev;
