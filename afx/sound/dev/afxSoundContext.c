...
_ASX afxNat AfxCountSoundBridges(afxSoundContext sctx, afxNat baseBridIdx)
{
    afxError err = AFX_ERR_NONE;
    AfxAssertObjects(1, &sctx, afxFcc_SCTX);
    AfxAssertRange(sctx->exuCnt, baseBridIdx, 1);
...
_ASX afxBool AfxGetSoundBridge(afxSoundContext sctx, afxNat portIdx, afxSoundBridge* bridge)
{
    ...
    AfxAssertRange(sctx->exuCnt, portIdx, 1);
    afxBool rslt;
...
_ASX afxNat AfxCountSoundQueues(afxSoundContext sctx, afxNat portIdx, afxNat baseQueIdx)
{
    afxError err = AFX_ERR_NONE;
    /// sctx must be a valid afxSoundContext handle.
    AfxAssertObjects(1, &sctx, afxFcc_SCTX);
    /// portIdx must be a valid index to a bridge.
    AfxAssertRange((afxNat)sctx->exuCnt, portIdx, 1);
    afxNat queCnt = 0;
    afxSoundBridge sdge;
...
_ASX void AfxCountSoundContextConnections(afxSoundContext sctx, afxNat* inputCnt, afxNat* outputCnt)
{
    afxError err = AFX_ERR_NONE;
    /// sctx must be a valid afxSoundContext handle.
    AfxAssertObjects(1, &sctx, afxFcc_SCTX);
...
_ASX afxNat AfxGetConnectedSoundInputs(afxSoundContext sctx, afxNat baseCon, afxNat cnt, afxSoundInput inputs[])
{
    afxError err = AFX_ERR_NONE;
    AfxAssertObjects(1, &sctx, afxFcc_SCTX);
    AfxAssert(inputs);
...
_ASX afxNat AfxGetConnectedSoundOutputs(afxSoundContext sctx, afxNat baseCon, afxNat cnt, afxSoundOutput outputs[])
{
    afxError err = AFX_ERR_NONE;
    AfxAssertObjects(1, &sctx, afxFcc_SCTX);
    AfxAssert(outputs);
...
_ASX afxNat AfxInvokeConnectedSoundInputs(afxSoundContext sctx, afxNat baseCon, afxNat cnt, afxBool(*f)(afxSoundInput, void*), void *udd)
{
    afxError err = AFX_ERR_NONE;
    AfxAssertObjects(1, &sctx, afxFcc_SCTX);
    AfxAssert(cnt);
...
_ASX afxNat AfxInvokeConnectedSoundOutputs(afxSoundContext sctx, afxNat baseCon, afxNat cnt, afxBool(*f)(afxSoundOutput, void*), void *udd)
{
    afxError err = AFX_ERR_NONE;
    AfxAssertObjects(1, &sctx, afxFcc_SCTX);
    AfxAssert(cnt);
...
_ASX afxError _AsxSctxStdCtorCb(afxSoundContext sctx, void** args, afxNat invokeNo)
{
    afxError err = AFX_ERR_NONE;
    AfxAssertObjects(1, &sctx, afxFcc_SCTX);
    //AfxAssert(spec);
