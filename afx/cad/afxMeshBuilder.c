...
#if 0
_AVX void _AfxMesh113131(afxMesh msh)
{
...
_AVXINL void AfxEndMeshBuilding(afxMeshBuilder* mshb)
{
    afxError err = NIL;
...
_AVXINL afxError AfxBeginMeshBuilding(afxMeshBuilder* mshb, afxString const* id, afxNat vtxCnt, afxNat triCnt, afxNat surfCnt, afxNat artCnt)
{
    afxError err = NIL;
    AfxAssert(mshb);
    AfxAssert(vtxCnt);
...
_AVXINL void AfxUpdateVertices(afxMeshBuilder* mshb, afxNat baseVtxIdx, afxNat vtxCnt, afxNat const baseBiasIdx[], afxNat const biasCnt[])
{
    afxError err = NIL;
    //AfxAssertType(mshb, afxFcc_MSHB);
...
_AVXINL void AfxUpdateVertexPositions(afxMeshBuilder* mshb, afxNat baseVtxIdx, afxNat vtxCnt, afxReal const posn[][3], afxNat srcStride)
{
    afxError err = NIL;
    //AfxAssertType(mshb, afxFcc_MSHB);
    AfxAssertRange(mshb->vtxCnt, baseVtxIdx, vtxCnt);
...
_AVXINL void AfxUpdateVertexPositions4(afxMeshBuilder* mshb, afxNat baseVtxIdx, afxNat vtxCnt, afxV4d const posn[], afxNat srcStride)
{
    afxError err = NIL;
    //AfxAssertType(mshb, afxFcc_MSHB);
    AfxAssertRange(mshb->vtxCnt, baseVtxIdx, vtxCnt);
...
_AVXINL afxError AfxUpdateVertexNormals(afxMeshBuilder* mshb, afxNat baseVtxIdx, afxNat vtxCnt, afxV3d const nrm[], afxNat srcStride)
{
    afxError err = NIL;
    //AfxAssertType(mshb, afxFcc_MSHB);
    AfxAssertRange(mshb->vtxCnt, baseVtxIdx, vtxCnt);
...
_AVXINL afxError AfxUpdateVertexWraps(afxMeshBuilder* mshb, afxNat baseVtxIdx, afxNat vtxCnt, afxV2d const uv[], afxNat srcStride)
{
    afxError err = NIL;
    //AfxAssertType(mshb, afxFcc_MSHB);
    AfxAssertRange(mshb->vtxCnt, baseVtxIdx, vtxCnt);
...
_AVXINL void AfxEmitTriangles(afxMeshBuilder* mshb, afxNat surfIdx, afxNat baseTriIdx, afxNat triCnt, afxNat const triVtxIdx[][3])
{
    afxError err = NIL;
    //AfxAssertType(mshb, afxFcc_MSHB);
...
_AVXINL afxNat AfxAddVertexBiases(afxMeshBuilder* mshb, afxNat cnt, afxNat const jntIdx[], afxReal const weight[])
{
    afxError err = NIL;
    //AfxAssertType(mshb, afxFcc_MSHB);
...
_AVXINL void AfxRenameVertexPivots(afxMeshBuilder* mshb, afxNat basePivotIdx, afxNat cnt, afxString const name[])
{
    afxError err = NIL;
    //AfxAssertType(mshb, afxFcc_MSHB);
...
_AVX afxMesh AfxBuildCubeMesh(afxDrawInput din, afxReal scale, afxNat secCnt)
{
    afxError err = NIL;
...
_AVX afxMesh AfxBuildDomeMesh(afxDrawInput din, afxReal radius, afxNat slices)
{
    afxError err = NIL;
    AfxAssertObjects(1, &din, afxFcc_DIN);
    AfxAssert(radius);
    ...
    afxMesh msh;
    AfxBuildMeshes(din, 1, &mshb, &msh);
    //AfxEndMeshBuilding(&mshb);

    return msh;
}

_AVX afxMesh AfxBuildDomeMesh2(afxDrawInput din, afxReal radius, afxNat stacks, afxNat slices, afxBool inv)
{
    afxError err = NIL;
    AfxAssertObjects(1, &din, afxFcc_DIN);
...
_AVX afxMesh AfxBuildSphereMesh(afxDrawInput din, afxReal radius, afxNat stacks, afxNat slices, afxBool inv)
{
    afxError err = NIL;
    AfxAssertObjects(1, &din, afxFcc_DIN);
...
_AVX afxMesh AfxBuildCapsuleMesh(afxDrawInput din, afxReal radius, afxReal height, afxNat stacks, afxNat slices, afxNat cylinderSlices, afxBool inv)
{
    afxError err = NIL;
    AfxAssertObjects(1, &din, afxFcc_DIN);
...
_AVX afxMesh AfxBuildPlaneMesh(afxDrawInput din, afxNat gridSizeX, afxNat gridSizeY, afxReal width, afxReal height)
{
    afxError err = NIL;
    AfxAssertObjects(1, &din, afxFcc_DIN);
