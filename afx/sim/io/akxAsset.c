...
_AMX afxError AfxDeserializeSkeletons(afxStream in, afxSimulation sim, afxNat cnt, afxSkeleton dst[])
{
    afxError err = NIL;
...
_AMX afxError AfxSerializeSkeletons(afxStream out, afxNat cnt, afxSkeleton const src[])
{
    afxError err = NIL;
...
_AMX afxNat AfxFindResourceNests(akxAsset cad, afxNat cnt, afxFcc const fcc[], afxNat nestIdx[])
{
...
_AMX afxNat AfxCountResources(akxAsset cad, afxFcc fcc)
{
    afxError err = AFX_ERR_NONE;
    AfxAssertObjects(1, &cad, afxFcc_CAD);
    AfxAssert(fcc);
...
_AMX afxNat AfxFindResources(akxAsset cad, afxFcc fcc, afxNat cnt, afxString const id[], void* res[])
{
    afxError err = AFX_ERR_NONE;
    AfxAssertObjects(1, &cad, afxFcc_CAD);
    AfxAssert(cnt);
...
_AMX afxNat AfxFindTextures(akxAsset cad, afxNat cnt, afxString const id[], afxRaster tex[])
{
    afxError err = AFX_ERR_NONE;
    AfxAssertObjects(1, &cad, afxFcc_CAD);
    AfxAssert(cnt);
...
_AMX afxNat AfxFindMaterials(akxAsset cad, afxNat cnt, afxString const id[], afxMaterial mt[])
{
    afxError err = AFX_ERR_NONE;
    AfxAssertObjects(1, &cad, afxFcc_CAD);
    AfxAssert(cnt);
...
_AMX afxNat AfxFindTopologies(akxAsset cad, afxNat cnt, afxString const id[], afxMeshTopology msht[])
{
    afxError err = AFX_ERR_NONE;
    AfxAssertObjects(1, &cad, afxFcc_CAD);
    AfxAssert(cnt);
...
_AMX afxNat AfxFindMeshes(akxAsset cad, afxNat cnt, afxString const id[], afxMesh msh[])
{
    afxError err = AFX_ERR_NONE;
    AfxAssertObjects(1, &cad, afxFcc_CAD);
    AfxAssert(cnt);
...
_AMX afxNat AfxFindSkeletons(akxAsset cad, afxNat cnt, afxString const id[], afxSkeleton skl[])
{
    afxError err = AFX_ERR_NONE;
    AfxAssertObjects(1, &cad, afxFcc_CAD);
    AfxAssert(cnt);
...
_AMX afxNat AfxFindModels(akxAsset cad, afxNat cnt, afxString const id[], afxModel mdl[])
{
    afxError err = AFX_ERR_NONE;
    AfxAssertObjects(1, &cad, afxFcc_CAD);
    AfxAssert(cnt);
...
_AMX afxNat AfxFindAnimations(akxAsset cad, afxNat cnt, afxString const id[], afxAnimation anim[])
{
    afxError err = AFX_ERR_NONE;
    AfxAssertObjects(1, &cad, afxFcc_CAD);
    AfxAssert(cnt);
...
_AMX afxError _AfxCadCtor(akxAsset cad, void** args, afxNat invokeNo)
{
    afxError err = AFX_ERR_NONE;
    AfxAssertObjects(1, &cad, afxFcc_CAD);
...
_AMX afxError AfxAcquireAssets(afxSimulation sim, afxNat cnt, afxNat const nestCnt[], afxNat const resCap[], akxAsset cad[])
{
    afxError err = AFX_ERR_NONE;
    AfxAssertObjects(1, &sim, afxFcc_SIM);
...
_AMX afxError AfxBuildAssets(afxSimulation sim, akxAssetBuilder const* cadb, afxNat cnt, void* data[], akxAsset cad[])
{
    afxError err = AFX_ERR_NONE;
    AfxAssertObjects(1, &sim, afxFcc_SIM);
...
_AMX afxError AfxLoadAssets(afxSimulation sim, afxError(*loader)(afxUri const* file, afxFlags flags), afxFlags flags, afxNat cnt, afxUri const file[])
{
    afxError err = AFX_ERR_NONE;
    AfxAssertObjects(1, &sim, afxFcc_SIM);
...
_AMX void AfxTransformAssets(afxM3d const ltm, afxM3d const iltm, afxV4d const atv, afxReal affineTol, afxReal linearTol, afxFlags flags, afxNat cnt, akxAsset cad[])
{
    afxError err = AFX_ERR_NONE;
    AfxAssert(ltm);
    AfxAssert(iltm);
...
#if 0
_AMX afxError AfxDeserializeMeshTopologies(afxStream in, afxSimulation sim, afxNat cnt, afxMeshTopology dst[])
{
    afxError err = NIL;
    AfxAssertObjects(1, &in, afxFcc_IOB);
    AfxAssert(dst);
...
_AMX afxError AfxSerializeMeshTopologies(afxStream out, afxNat cnt, afxMeshTopology const src[])
{
    afxError err = NIL;
    AfxAssertObjects(1, &out, afxFcc_IOB);
    AfxAssert(src);
