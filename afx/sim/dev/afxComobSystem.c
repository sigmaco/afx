...
_AMX afxNat AfxCountPragmaPorts(afxComboDevice mdev)
{
    afxError err = AFX_ERR_NONE;
    AfxAssertObjects(1, &mdev, afxFcc_MDEV);
    return mdev->portCnt;
...
_AMX afxError _AmxMdevCtorCb(afxComboDevice mdev, void** args, afxNat invokeNo)
{
    afxError err = AFX_ERR_NONE;
    AfxAssertObjects(1, &mdev, afxFcc_MDEV);
...
_AMX afxNat AfxInvokeComboDevices(afxNat first, afxNat cnt, afxBool(*f)(afxComboDevice, void*), void *udd)
{
    afxError err = AFX_ERR_NONE;
    AfxAssert(cnt);
    AfxAssert(f);
...
_AMX afxNat AfxEvokeComboDevices(afxBool(*flt)(afxComboDevice, void*), void* fdd, afxNat first, afxNat cnt, afxComboDevice devices[])
{
    afxError err = AFX_ERR_NONE;
    AfxAssert(cnt);
    AfxAssert(devices);
...
_AMX afxNat AfxEnumerateComboDevices(afxNat first, afxNat cnt, afxComboDevice devices[])
{
    afxError err = AFX_ERR_NONE;
    AfxAssert(cnt);
    AfxAssert(devices);
...
_AMX afxBool AfxGetComboDevice(afxNat mdevId, afxComboDevice* device)
{
    afxError err = AFX_ERR_NONE;
...
_AMX afxError _AmxRegisterComboDevices(afxModule icd, afxNat cnt, afxComboDeviceInfo const infos[], afxComboDevice devices[])
{
    afxError err = AFX_ERR_NONE;
    AfxAssertObjects(1, &icd, afxFcc_MDLE);
    AfxAssert(devices);
