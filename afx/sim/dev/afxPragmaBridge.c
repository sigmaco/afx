...
_AMX afxPragmaDevice AfxGetMathBridgeDevice(afxPragmaBridge mdge)
{
    afxError err = AFX_ERR_NONE;
    AfxAssertObjects(1, &mdge, afxFcc_MDGE);
    afxPragmaDevice ddev = AfxGetParent(mdge);
    AfxAssertObjects(1, &ddev, afxFcc_DDEV);
    return ddev;
}

_AMX afxSimulation AfxGetMathBridgeContext(afxPragmaBridge mdge)
{
    afxError err = AFX_ERR_NONE;
    AfxAssertObjects(1, &mdge, afxFcc_MDGE);
...
_AMX afxNat AfxGetMathBridgePort(afxPragmaBridge mdge)
{
    afxError err = AFX_ERR_NONE;
    AfxAssertObjects(1, &mdge, afxFcc_MDGE);
    return mdge->portIdx;
...
_AMX afxClass const* _AmxGetMathQueueClass(afxPragmaBridge mdge)
{
    afxError err = AFX_ERR_NONE;
    /// mdge must be a valid afxPragmaBridge handle.
    AfxAssertObjects(1, &mdge, afxFcc_MDGE);
...
_AMX afxNat _AmxCountMathQueues(afxPragmaBridge mdge, afxNat baseQueIdx)
{
    afxError err = AFX_ERR_NONE;
    /// mdge must be a valid afxPragmaBridge handle.
    AfxAssertObjects(1, &mdge, afxFcc_MDGE);
...
_AMX afxBool _AmxGetMathQueue(afxPragmaBridge mdge, afxNat queIdx, afxMathQueue* queue)
{
    afxError err = AFX_ERR_NONE;
    /// mdge must be a valid afxPragmaBridge handle.
    AfxAssertObjects(1, &mdge, afxFcc_MDGE);
...
_AMX afxError _AmxWaitForIdleMathQueue(afxPragmaBridge mdge, afxNat queIdx)
{
    afxError err = AFX_ERR_NONE;
    /// mdge must be a valid afxPragmaBridge handle.
    AfxAssertObjects(1, &mdge, afxFcc_MDGE);
...
_AMX afxError _AmxWaitForIdleMathBridge(afxPragmaBridge mdge)
{
    afxError err = AFX_ERR_NONE;
    /// mdge must be a valid afxPragmaBridge handle.
    AfxAssertObjects(1, &mdge, afxFcc_MDGE);
...
_AMX void _AmxBeginMathQueueDebugScope(afxPragmaBridge mdge, afxNat queIdx, afxString const* name, afxColor const color)
{
    afxError err = AFX_ERR_NONE;
    /// mdge must be a valid afxPragmaBridge handle.
    AfxAssertObjects(1, &mdge, afxFcc_MDGE);
...
_AMX void _AmxEndMathQueueDebugScope(afxPragmaBridge mdge, afxNat queIdx)
{
    afxError err = AFX_ERR_NONE;
    /// mdge must be a valid afxPragmaBridge handle.
    AfxAssertObjects(1, &mdge, afxFcc_MDGE);
...
_AMX void _AmxPushMathQueueDebugLabel(afxPragmaBridge mdge, afxNat queIdx, afxString const* name, afxColor const color)
{
    afxError err = AFX_ERR_NONE;
    /// mdge must be a valid afxPragmaBridge handle.
    AfxAssertObjects(1, &mdge, afxFcc_MDGE);
...
_AMX afxNat _AmxSubmitMathCommands(afxPragmaBridge mdge, amxSubmission const* ctrl, afxNat cnt, avxCmdb cmdbs[])
{
    afxError err = AFX_ERR_NONE;
    AfxAssertObjects(1, &mdge, afxFcc_MDGE);
    AfxAssert(cnt);
...
_AMX afxNat _AmxSubmitMathWorkRequest(afxPragmaBridge mdge, afxNat cnt, amxQueueOp const subm[])
{
    afxError err = AFX_ERR_NONE;
    AfxAssertObjects(1, &mdge, afxFcc_MDGE);
    AfxAssert(cnt);
...
_AMX afxError _AmxMdgeStdDtorCb(afxPragmaBridge mdge)
{
    afxError err = AFX_ERR_NONE;
    AfxAssertObjects(1, &mdge, afxFcc_MDGE);
    ...
    afxPragmaDevice mdev = AfxGetMathBridgeDevice(mdge);
    ...
    AfxCleanUpChainedClasses(&mdge->classes);
...
_AMX afxError _AmxMqueStdCtorCb(afxMathQueue mque, void** args, afxNat invokeNo)
{
    ...
    afxPragmaBridge mdge = args[1];
    AfxAssertObjects(1, &mdge, afxFcc_MDGE);
    afxPragmaBridgeConfig const *cfg = ((afxPragmaBridgeConfig const *)args[2]);
    AfxAssert(cfg);
...
_AMX afxError _AmxMdgeStdCtorCb(afxPragmaBridge mdge, void** args, afxNat invokeNo)
{
    afxError err = AFX_ERR_NONE;
    AfxAssertObjects(1, &mdge, afxFcc_MDGE);

    afxPragmaDevice mdev = args[0];
...
_AMX afxClassConfig const _AmxMdgeStdImplementation =
{
    ...
    .fixedSiz = sizeof(AFX_OBJECT(afxPragmaBridge)),
