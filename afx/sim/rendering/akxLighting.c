...
_AMX afxError _AfxLitCtor(akxLight lit, void** args, afxNat invokeNo)
{
    afxError err = AFX_ERR_NONE;
    AfxAssertObjects(1, &lit, afxFcc_LIT);
...
_AMX afxError AfxAcquireDirectionalLights(afxSimulation sim, afxNat cnt, afxNat uid[])
{
    afxError err = AFX_ERR_NONE;
...
_AMX afxError AfxAcquireOmniLights(afxSimulation sim, afxNat cnt, afxNat uid[])
{
    afxError err = AFX_ERR_NONE;
    AfxAssertObjects(1, &sim, afxFcc_SIM);
    akxLight lit;
...
_AMX afxError AfxAcquireSpotLights(afxSimulation sim, afxNat cnt, afxNat uid[])
{
    afxError err = AFX_ERR_NONE;
    AfxAssertObjects(1, &sim, afxFcc_SIM);
    akxLight lit;
