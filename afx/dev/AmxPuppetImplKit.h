...
{
    afxNat          srcTrackIdx; // short afxMotionTransform
...
AFX_DEFINE_STRUCT(akxMotiveCallbacks)
{
    ...
    void(*AccumulateBindingState)(akxMotive*, afxNat, afxNat, afxPose*, afxReal, afxNat const*);
    void(*BuildBindingDirect)(akxMotive*, afxNat, afxReal const*, afxPoseBuffer*, afxReal);
...
AFX_OBJECT(afxMotor)
{
    ...
    afxNat32        easeInValues;
    afxNat32        easeOutValues;
    void*           userData[4];
};
#endif//_AMX_MOTOR_C
