...
_AVX afxError _AvxPresentDrawOutput(afxDrawOutput dout, afxNat bufIdx, afxSize unk)
{
    afxError err = AFX_ERR_NONE;
    AfxAssertObjects(1, &dout, afxFcc_DOUT);
    ...
    if (dout->presentCb && dout->presentCb(dout, bufIdx, unk))
        AfxThrowError();
...
_AVX afxDrawDevice AfxGetDrawOutputDevice(afxDrawOutput dout)
{
    ...
    AfxAssertObjects(1, &dout, afxFcc_DOUT);
    afxDrawDevice ddev = AfxGetParent(dout);
...
_AVX afxError AfxReserveDrawOutputBuffer(afxDrawOutput dout, afxTime timeout, afxNat *bufIdx)
...
_AVX afxError _AvxDoutCtorCb(afxDrawOutput dout, void** args, afxNat invokeNo)
{
    ...
    dout->pixelFmt = cfg->pixelFmt ? cfg->pixelFmt : afxPixelFormat_ARGB8; // or afxPixelFormat_RGBA8R ?
...
_AVX afxError AfxConfigureDrawOutput(afxNat ddevId, afxDrawOutputConfig* cfg)
{
    ...
    else
    {
        ...
        *cfg = (afxDrawOutputConfig const) { 0 };
        ...
        cfg->pixelFmt = afxPixelFormat_ARGB8;
