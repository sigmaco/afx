...
AFX_OBJECT(afxIoQueue)
{
    ...
    afxError        (*submitCb)(afxIoQueue, afxSubmission const*, afxNat, afxObject[]);
    afxError        (*transferCb)(afxIoQueue, afxTransference const*, afxNat, void const*);
};
...
AFX_OBJECT(afxIoBridge)
{
    ...
    afxError        (*waitCb)(afxIoBridge, afxNat);
    afxError        (*pingCb)(afxIoBridge, afxNat);
};
#endif//_AFX_IO_BRIDGE_C

_AFX afxNat AfxGetIoQueuePort(afxIoQueue xque)
{
...
_AFX afxError _AfxXqueStdCtorCb(afxIoQueue xque, void** args, afxNat invokeNo)
{
    afxError err = AFX_ERR_NONE;
    AfxAssertObjects(1, &xque, afxFcc_XQUE);
...
_AFX afxNat AfxGetIoBridgePort(afxIoBridge xexu)
{
    afxError err = AFX_ERR_NONE;
    AfxAssertObjects(1, &xexu, afxFcc_XEXU);
    return xexu->portId;
...
_AFX afxNat AfxGetIoQueues(afxIoBridge xexu, afxNat first, afxNat cnt, afxIoQueue queues[])
{
    afxError err = AFX_ERR_NONE;
    ...
    afxNat xqueCnt = xexu->queCnt;
    AfxAssertRange(xqueCnt, first, cnt);
...
_AFX afxError _AfxSubmitIoCommands(afxIoBridge xexu, afxSubmission const* ctrl, afxNat cnt, afxObject cmdbs[])
{
    afxError err = AFX_ERR_NONE;
    AfxAssertObjects(1, &xexu, afxFcc_XEXU);
    AfxAssert(cnt);
    ...
    */
    ...
    afxNat queCnt = AfxMin(xexu->queCnt, AfxMax(1, ctrl->queCnt));
...
_AFX afxError _AfxSubmitTransferences(afxIoBridge xexu, afxTransference const* ctrl, afxNat opCnt, void const* ops)
{
    afxError err = AFX_ERR_NONE;
    AfxAssertObjects(1, &xexu, afxFcc_XEXU);
    AfxAssert(opCnt);
...
_AFX afxError _AfxXexuStdDtorCb(afxIoBridge xexu)
{
    ...
    AfxDeallocateInstanceData(xexu, AFX_COUNTOF(stashes), stashes);
...
_AFX afxError _AfxXexuStdCtorCb(afxIoBridge xexu, void** args, afxNat invokeNo)
{
    afxError err = AFX_ERR_NONE;
    AfxAssertObjects(1, &xexu, afxFcc_XEXU);
    ...
    else
    {
        ...
        if (AfxAllocateInstanceData(xexu, AFX_COUNTOF(stashes), stashes)) AfxThrowError();
        else
        {
