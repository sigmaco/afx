...
_AVXINL void AfxColorCopyRgba8(afxColor c, afxNat rgba)
{
    afxError err = AFX_ERR_NONE;
    AfxAssert(c);
...
_AVXINL void AfxColorCopyArgb8(afxColor c, afxNat argb)
{
    afxError err = AFX_ERR_NONE;
    AfxAssert(c);
...
_AVXINL afxNat32 AfxGetColorAsRgba8(afxColor const c)
{
    afxError err = AFX_ERR_NONE;
    AfxAssert(c);
    return ((((afxNat32)(c[0] * 255.0f)) << 24) | (((afxNat32)(c[1] * 255.0f)) << 16) | (((afxNat32)(c[2] * 255.0f)) << 8) | ((afxNat32)(c[3] * 255.0f)));
}

_AVXINL afxNat32 AfxGetColorAsArgb8(afxColor const c)
{
    afxError err = AFX_ERR_NONE;
    AfxAssert(c);
    return ((((afxNat32)(c[3] * 255.0f)) << 24) | (((afxNat32)(c[0] * 255.0f)) << 16) | (((afxNat32)(c[1] * 255.0f)) << 8) | ((afxNat32)(c[2] * 255.0f)));
}
