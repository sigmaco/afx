...
_AFX void AfxComputeCompositeTransformM4dc(afxTransform const* t, afxM4dc m)
{
...
void BuildSingleCompositeFromWorldPoseTranspose_Generic(afxM4d const InverseWorld4x4, afxM4d const WorldMatrix, afxM4dc ResultComposite3x4)
{
