...
_AUX afxError AfxEmulatePressedKeys(afxSession ses, afxNat seat, afxNat cnt, afxKey const key[], afxNat8 const pressure[], afxWindow wnd)
{
...
_AUX afxBool AfxWereKeysReleased(afxSession ses, afxNat seat, afxNat cnt, afxKey const codes[])
{
    afxError err = AFX_ERR_NONE;
    afxBool rslt = FALSE;
    AfxAssertObjects(1, &ses, afxFcc_SES);
...
_AUX afxBool AfxWasKeyReleased(afxSession ses, afxNat seat, afxKey code)
{
    afxError err = AFX_ERR_NONE;
    afxBool rslt = FALSE;
    AfxAssertObjects(1, &ses, afxFcc_SES);
...
_AUX afxBool AfxWereKeysPressed(afxSession ses, afxNat seat, afxNat cnt, afxKey const codes[])
{
    afxError err = AFX_ERR_NONE;
    afxBool rslt = FALSE;
    AfxAssertObjects(1, &ses, afxFcc_SES);
...
_AUX afxBool AfxWasKeyPressed(afxSession ses, afxNat seat, afxKey code)
{
    afxError err = AFX_ERR_NONE;
    afxBool rslt = FALSE;
    AfxAssertObjects(1, &ses, afxFcc_SES);
...
_AUX afxBool AfxIsKeyPressed(afxSession ses, afxNat seat, afxKey code)
{
    afxError err = AFX_ERR_NONE;
    afxBool rslt = FALSE;
    AfxAssertObjects(1, &ses, afxFcc_SES);
...
_AUX afxReal AfxGetCombinedKeyPressure(afxSession ses, afxNat seat, afxKey lhs, afxKey rhs)
{
    afxError err = AFX_ERR_NONE;
...
_AUX afxReal AfxGetKeyPressure(afxSession ses, afxNat seat, afxKey code)
{
    afxError err = AFX_ERR_NONE;
    afxReal pressure = 0.0;
    AfxAssertObjects(1, &ses, afxFcc_SES);
...
_AUX afxResult AfxCountPressedKeys(afxSession ses, afxNat seat)
{
    afxError err = AFX_ERR_NONE;
    afxResult c = 0;
    AfxAssertObjects(1, &ses, afxFcc_SES);
...
_AUX afxResult _AuxKbdCtorCb(afxKeyboard kbd, void** args, afxNat invokeNo)
{
    afxError err = AFX_ERR_NONE;
    AfxAssertObjects(1, &kbd, afxFcc_KBD);
