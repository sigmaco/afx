...
typedef enum afxFcc
{
    ...
    afxFcc_DIN      = AFX_MAKE_FCC('d', 'i', 'n', '\0'), // arxRenderware
    ...
    afxFcc_SURF     = AFX_MAKE_FCC('s', 'u', 'r', 'f'), // _avxCanvasUnit
    ...
    afxFcc_MSHR     = AFX_MAKE_FCC('m', 's', 'h', 'r'), // _arxRiggedMesh
    ...
    afxFcc_SCN      = AFX_MAKE_FCC('s', 'c', 'n', '\0'), // arxScene
