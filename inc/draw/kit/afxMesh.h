...
#include "qwadro/inc/draw/kit/afxTriangulation.h"
...
AVX afxError        AfxResetMeshSections(afxMesh msh, afxUnit baseSecIdx, afxUnit cnt, afxMeshSection const sections[]);
...
AVX afxUnit AfxFindVertexAttributes(afxMesh msh, afxUnit cnt, afxString const usages[], afxUnit indices[]);
AVX afxError AfxDescribeVertexAttribute(afxMesh msh, afxUnit attrIdx, afxVertexAttribute* info);
AVX afxError AfxFormatVertexAttribute(afxMesh msh, afxUnit attrIdx, avxFormat fmt, afxVertexFlags flags, afxString const* usage);
AVX void* AfxAccessVertexData(afxMesh msh, afxUnit attrIdx, afxUnit morphIdx, afxUnit baseVtx);
AVX afxError AfxUpdateVertexData(afxMesh msh, afxUnit attrIdx, afxUnit morphIdx, afxUnit baseVtx, afxUnit vtxCnt, void const* src, afxUnit32 srcStride);
AVX afxError AfxUploadVertexData(afxMesh msh, afxUnit attrIdx, afxUnit morphIdx, afxUnit baseVtx, afxUnit vtxCnt, afxStream in, afxUnit stride);
AVX afxError AfxDownloadVertexData(afxMesh msh, afxUnit attrIdx, afxUnit morphIdx, afxUnit baseVtx, afxUnit vtxCnt, afxStream out, afxUnit stride);
AVX afxError AfxInvertVertexData(afxMesh msh, afxUnit attrIdx, afxUnit morphIdx, afxUnit baseVtx, afxUnit vtxCnt);
AVX afxError AfxNormalizeVertexData(afxMesh msh, afxUnit attrIdx, afxUnit morphIdx, afxUnit baseVtx, afxUnit vtxCnt);
