...
AVX afxNat              AfxCountDrawQueues(afxDrawBridge dexu, afxNat first);
AVX afxNat              AfxGetDrawQueues(afxDrawBridge dexu, afxNat first, afxNat cnt, afxDrawQueue queues[]);

AVX void                _AvxBeginDrawQueueDebugScope(afxDrawBridge dexu, afxNat queIdx, afxString const* name, afxColor const color);
AVX void                _AvxEndDrawQueueDebugScope(afxDrawBridge dexu, afxNat queIdx);
AVX void                _AvxPushDrawQueueDebugLabel(afxDrawBridge dexu, afxNat queIdx, afxString const* name, afxColor const color);

AVX afxNat              _AvxSubmitDrawCommands(afxDrawBridge dexu, avxSubmission const* ctrl, afxNat cnt, avxCmdb cmdbs[]);
AVX afxNat              _AvxSubmitTransferences(afxDrawBridge dexu, avxTransference const* ctrl, afxNat opCnt, void const* ops);

AVX afxNat              _AvxSubmitDrawWorkRequest(afxDrawBridge dexu, afxNat cnt, avxQueueOp const subm[]);
