...
#include "qwadro/inc/draw/dev/afxDrawOutput.h"
...
AVX afxNat          AfxCountDrawBridges(afxDrawContext dctx, afxNat portId, afxNat baseExu);

/// Get a bridge handle from a device context.
/// Get a queue handle from a device context.

AVX afxNat          AfxQueryDrawBridges(afxDrawContext dctx, afxNat portId, afxNat first, afxNat cnt, afxDrawBridge bridges[]);
AVX afxNat          AfxQueryDrawQueues(afxDrawContext dctx, afxNat portId, afxNat first, afxNat cnt, afxDrawQueue queues[]);
AVX afxNat          AfxGetDrawBridges(afxDrawContext dctx, afxNat first, afxNat cnt, afxDrawBridge bridges[]);
AVX afxBool         AfxGetDrawQueue(afxDrawContext dctx, afxNat exuIdx, afxNat queIdx, afxDrawQueue* queue);
...
AVX afxError        AfxWaitForDrawBridge(afxDrawContext dctx, afxNat exuIdx);
AVX afxError        AfxWaitForDrawQueue(afxDrawContext dctx, afxNat exuIdx, afxNat queIdx);
