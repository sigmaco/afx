...
AMX afxReal     AfxGetWaveDuration(afxAudio wav);

AMX void        AfxDescribeAudio(afxAudio wav, afxAudioInfo* desc);

AMX afxError    AfxUploadAudio(afxAudio wav, afxUnit opCnt, afxWaveIo const ops[], afxStream in, afxUnit portIdx);
AMX afxError    AfxDownloadAudio(afxAudio wav, afxUnit opCnt, afxWaveIo const ops[], afxStream out, afxUnit portIdx);

AMX afxError    AfxDumpAudio(afxAudio wav, afxUnit opCnt, afxWaveIo const ops[], void* dst, afxUnit portIdx);
AMX afxError    AfxUpdateAudio(afxAudio wav, afxUnit opCnt, afxWaveIo const ops[], void const* src, afxUnit portIdx);

AMX afxError    AfxPrintAudio(afxAudio wav, afxWaveInterval const* op, afxUri const* uri);

////////////////////////////////////////////////////////////////////////////////

AMX afxError    AfxAcquireAudios(afxMixSystem msys, afxUnit cnt, afxAudioInfo const info[], afxAudio buffers[]);
