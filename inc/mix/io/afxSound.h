...
AMX afxError    AfxDoSound(afxMixSystem msys, afxSoundInfo const* info, afxUnit* sndId);

AMX afxError    AfxStopSound(afxMixSystem msys, afxUnit sndId);

AMX void        AmxTransformSound(afxSound snd, afxTransform const* t);

AMX afxUnit     AmxAccumulateSoundSamples(afxSound snd, afxUnit sampleCnt, afxUnit chCnt, afxUnit freq, afxUnit bufCap, afxReal output[]);

AMX afxError    AmxRewindSound(afxSound snd);
AMX afxBool     AmxHasSoundEnded(afxSound snd);
