...
/**
    ...
    dependency between queue operations or between a queue operation and the host.
    Binary semaphores have two states - signaled and unsignaled. 
    Timeline semaphores have a strictly increasing 64-bit unsigned integer payload 
    ...
    AfxSignalSemaphore command and waited on from the host with the AfxWaitSemaphores command.
*/
