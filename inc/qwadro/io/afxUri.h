...
AFXINL afxNat           AfxMakeUriFromRestring(afxUri* uri, afxString const *src);
AFXINL afxNat           AfxMakeUriFromRestringRange(afxUri* uri, afxString const *src, afxNat offset, afxNat len);
