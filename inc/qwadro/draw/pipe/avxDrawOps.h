...
#include "qwadro/draw/pipe/avxRasterOps.h"
#include "qwadro/draw/pipe/avxBufferOps.h"
#include "qwadro/draw/pipe/avxSampler.h"
#include "qwadro/draw/io/afxTypography.h"
#include "qwadro/draw/pipe/avxQueryOps.h"
#include "qwadro/draw/pipe/avxPipeline.h"
#include "qwadro/draw/pipe/avxTransformationOps.h"
#include "qwadro/draw/pipe/avxRasterizationOps.h"
...
AFX_DEFINE_STRUCT(afxCmd)
{
    ...
    struct // vertex transformation ops
    {
        ...
        afxCmdId(*AdjustViewports)(avxCmdb cmdb, afxNat baseIdx, afxNat cnt, avxViewport const vp[]);
