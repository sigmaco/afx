...
AVX afxError        AfxUpdateRaster(afxRaster ras, afxNat portIdx, afxNat opCnt, afxRasterIo const ops[], void const* src);
AVX afxError        AfxDumpRaster(afxRaster ras, afxNat portIdx, afxNat opCnt, afxRasterIo const ops[], void* dst);

// Stream in/out texture raster data from/to a stream.
AVX afxError        AfxUploadRaster(afxRaster ras, afxNat portIdx, afxNat opCnt, afxRasterIo const ops[], afxStream in);
AVX afxError        AfxDownloadRaster(afxRaster ras, afxNat portIdx, afxNat opCnt, afxRasterIo const ops[], afxStream out);
...
AVX afxError        AfxPrintRaster(afxRaster ras, afxNat portIdx, afxRasterIo const* op, afxNat lodCnt, afxUri const* uri);
