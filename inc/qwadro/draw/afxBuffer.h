...
AVX afxError        AfxUploadBuffer(afxBuffer buf, afxNat portIdx, afxNat opCnt, afxBufferIo const ops[], afxStream in);
AVX afxError        AfxDownloadBuffer(afxBuffer buf, afxNat portIdx, afxNat opCnt, afxBufferIo const ops[], afxStream out);

AVX afxError        AfxDumpBuffer(afxBuffer buf, afxNat portIdx, afxNat opCnt, afxBufferIo const ops[], void *dst);
AVX afxError        AfxUpdateBuffer(afxBuffer buf, afxNat portIdx, afxNat opCnt, afxBufferIo const ops[], void const *src);
