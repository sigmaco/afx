...
AKX void                AfxGetWorldMatrixFromLocalPose(afxSkeleton skl, afxNat jointIdx, akxPose const lp, afxM4d const offset, afxM4d m, afxNat const* sparseBoneArray, afxNat const* sparseBoneArrayReverse);
AKX void                AfxGetSkeletonAttachmentOffset(afxSkeleton skl, afxNat jointIdx, akxPose const lp, afxM4d const offset, afxM4d m, afxNat const* sparseArtArray, afxNat const* sparseArtArrayReverse);
...
AKX void                AfxComputeRestLocalPose(afxSkeleton skl, afxNat baseJoint, afxNat jointCnt, akxPose lp);
AKX void                AfxComputeRestPoseBuffer(afxSkeleton skl, afxNat baseJoint, afxNat jointCnt, afxM4d const offset, akxPoseBuffer wp);

AKX void                AfxComputePoseBuffer(afxSkeleton skl, afxNat baseJoint, afxNat jointCnt, akxPose const lp, afxM4d const offset, akxPoseBuffer wp);
AKX void                AfxComputePoseBufferLod(afxSkeleton skl, afxNat baseJoint, afxNat jointCnt, afxNat firstValidLocalArt, afxNat validLocalArtCnt, akxPose const lp, afxM4d const offset, akxPoseBuffer wp);
AKX void                AfxComputePoseBufferNoCompositeLod(afxSkeleton skl, afxNat baseJoint, afxNat jointCnt, afxNat firstValidLocalArt, afxNat validLocalArtCnt, akxPose const lp, afxM4d const offset, akxPoseBuffer wp);
