...
AFX afxError    AfxSetUpInterlockedQueue(afxInterlockedQueue* ique, afxNat unitSiz, afxNat cap);

/// Libera a memória reservado para a fila e redefine o estado interno.
/// A fila deve estar vazia quando esta função for chamada.
AFX afxError    AfxCleanUpInterlockedQueue(afxInterlockedQueue* ique);
