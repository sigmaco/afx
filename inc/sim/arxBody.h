...
#include "qwadro/inc/render/anim/arxCapstan.h"
...
ARX void        ArxStepBodyMotives(arxBody bod, afxReal /* NOT delta */ newClock);
...
ARX afxUnit     ArxPerformManipulatedPose(arxPose pose, afxReal startTime, afxReal duration, afxUnit iterCnt, akxTrackMask* modelMask, afxUnit cnt, arxBody bodies[]);
