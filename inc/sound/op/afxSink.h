...
ASX afxSoundDevice  AfxGetAudioSinkDevice(afxSink sink);
ASX afxSoundSystem  AfxGetAudioSinkContext(afxSink sink);

ASX afxError        AfxGetAudioSinkIdd(afxSink sink, afxUnit code, void* dst);

// Connection

ASX afxError        AfxMuteAudioSink(afxSink sink, afxBool mute);

ASX afxError        AfxRequestSinkBuffer(afxSink sink, afxTime timeout, afxUnit *bufIdx);
ASX afxError        AfxDiscardSinkBuffer(afxSink sink, afxUnit bufIdx);

////////////////////////////////////////////////////////////////////////////////

ASX afxError        AfxConfigureAudioSink(afxSoundSystem ssys, afxSinkConfig* cfg);

ASX afxError        AfxOpenAudioSink(afxSoundSystem ssys, afxSinkConfig const* cfg, afxSink* sink);
