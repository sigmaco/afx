...
AFXINL afxBool      AfxAabbContainsAabbs(afxBox const* bb, afxUnit cnt, afxBox const other[]);
AFXINL afxUnit      AfxAabbTestAtv3d(afxBox const* bb, afxUnit cnt, afxV3d const v[]);
AFXINL afxBool      AfxAabbContainsSpheres(afxBox const* bb, afxUnit cnt, afxSphere const sph[]);
