...
_SGL afxError _SglDdevInitDout(afxDrawDevice ddev, afxDrawOutput dout, afxDrawOutputConfig const* cfg, afxUri const* endpoint)
{
    afxError err = AFX_ERR_NONE;
    AfxAssertObjects(1, &ddev, afxFcc_DDEV);
    AfxAssertObjects(1, &dout, afxFcc_DOUT);
    ...
    if (wnd)
    {
        ...
        else
        {
            ...
            dout->w32.hDc = dc;
            dout->endpointObj = cfg->endpointObj;
            dout->endpointNotifier = cfg->endpointNotifier;
