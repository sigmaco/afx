...
AFX awxMesh             AwxAssembleMesh(afxSimulation sim, awxVertexData vtd, afxNat baseVtx, afxNat vtxCnt, awxMeshTopology msht, afxNat baseSurf, afxNat surfCnt, afxString const pivots[]);

AFX afxError            AwxBuildMeshes(afxSimulation sim, afxNat cnt, awxMeshBuilder const mshb[], awxMesh msh[]);
