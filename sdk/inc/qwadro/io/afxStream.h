...
AFX_DEFINE_STRUCT(afxStreamImpl)
{
...
AFX_DECLARE_STRUCT(afxStreamIdd);

#ifdef _AFX_CORE_C
#ifdef _AFX_STREAM_C

AFX_DEFINE_STRUCT(afxStreamIdd)
{
    struct
    {
...
AFX afxStreamImpl const     stdStreamImpl;

AFX afxStream               AfxAcquireImplementedStream(afxIoFlags flags, afxStreamImpl const* pimpl, afxStreamIdd const* idd);
...
AFX afxStream               AfxAcquireStream(afxIoFlags flags, afxNat siz);
AFX afxStream               AfxOpenStream(afxIoFlags flags, afxNat cap, void const* start, afxSize length);
AFX afxStream               AfxOpenInputStream(afxNat cap, void const* start, afxSize length);
AFX afxStream               AfxOpenOutputStream(afxNat cap, void* start, afxSize length);
