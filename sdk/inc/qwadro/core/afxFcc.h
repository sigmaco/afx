...
typedef enum afxFcc
{
    ...
    afxFcc_OBJ      = AfxPackFcc('o', 'b', 'j', '\0'), // afxHandle
    ...
    afxFcc_DEV      = AfxPackFcc('d', 'e', 'v', '\0'), // afxDevice
    ...
    afxFcc_OVLY     = AfxPackFcc('o', 'v', 'l', 'y'), // afxOverlay
    ...
    afxFcc_SQUE     = AfxPackFcc('s', 'q', 'u', 'e'), // afxSoundQueue
    afxFcc_SBUF     = AfxPackFcc('s', 'b', 'u', 'f'), // afxSoundBuffer
    afxFcc_AUD      = AfxPackFcc('a', 'u', 'd', '\0'), // afxListener
