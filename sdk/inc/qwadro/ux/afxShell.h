...
AUX afxError    AfxLoadScript(afxString const* domain, afxUri const* uri);

AUX afxError    AfxAcquireScript(afxString const* domain, afxString const* code);

AUX afxError    AfxInjectScript(afxString const* domain, afxString const* code);
...
AUX afxError        AfxAcquireShell(afxShell* shell);
