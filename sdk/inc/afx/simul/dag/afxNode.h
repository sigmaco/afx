...
AFX_DEFINE_STRUCT(afxNodeSpecification)
{
    ...
    afxResult       (*update)(afxNode nod, afxReal dt);
    afxV4d const    *m;
...
AFX afxV4d*         AfxNodeCopyTransform(afxNode nod, afxM4d m); // afxM4d m;

AFX afxV4d const*   AfxNodeGetAbsoluteTransform(afxNode nod); // afxM4d w;
AFX afxV4d*         AfxNodeCopyAbsoluteTransform(afxNode nod, afxM4d w); // afxM4d w;
...
AFX afxReal*        AfxNodeCopyTranslation(afxNode nod, afxV4d translation);
    
AFX void            AfxNodeAddScale(afxNode nod, afxV3d const scale);
AFX void            AfxNodeSetScale(afxNode nod, afxV3d const scale);
AFX void            AfxNodeResetScale(afxNode nod);
AFX afxReal*        AfxNodeCopyScale(afxNode nod, afxV3d scale);
...
AFX afxReal*        AfxNodeCopyRotation(afxNode nod, afxQuat rotation);

#if 0
AFX void            AfxNodeReorientTo(afxNode nod, afxV3d const dir);
AFX void            AfxNodeReorientAt(afxNode nod, afxV3d const center);
#endif//0
AFX afxAabb*        AfxNodeGetExtent(afxNode nod, afxAabb *aabb); // the volumetric area covered by this node. The sum of vertices of models, frustum of camera projection, light spheres, etc.
AFX afxAabb*        AfxNodeGetAmplitude(afxNode nod, afxAabb *aabb); // the sum of extent with its children as a scope.
