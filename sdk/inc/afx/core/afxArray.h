...
AFX void*       AfxInsertArrayUnits(afxArray *arr, afxNat cnt, afxNat *firstIdx, void const *initialVal);
AFX void        AfxPopArrayUnits(afxArray *arr, afxNat cnt);

AFX afxError    AfxAddArrayUnits(afxArray *arr, afxNat cnt, void const* src, afxNat srcStride, afxNat* firstIdx);
AFX afxError    AfxUpdateArrayUnits(afxArray *arr, afxNat base, afxNat cnt, void const* src, afxNat srcStride);
