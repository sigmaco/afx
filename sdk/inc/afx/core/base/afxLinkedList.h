...
AFXINL afxLinkage* AfxChainGetFirstLinkage(afxChain const *ch);

AFXINL afxLinkage* AfxChainGetLastLinkage(afxChain const *ch);

AFXINL afxLinkage* AfxChainGetDummyLinkage(afxChain *ch);

AFXINL afxLinkage const* AfxChainGetDummyLinkageConst(afxChain const *ch);
...
#define AfxChainForEveryLinkage2(ch_, type_, offset_, lnk_) for (afxLinkage *_next##lnk2_ = (afxLinkage*)NIL, *_curr##lnk2_ = (ch_)->dummy.next; _next##lnk2_ = (_curr##lnk2_)->next, lnk_ = (type_*)AfxContainerOf(_curr##lnk2_, type_, offset_), (_curr##lnk2_) != &(ch_)->dummy; _curr##lnk2_ = _next##lnk2_)
#define AfxChainForEveryLinkage(ch_, type_, offset_, lnk_) for (afxLinkage *_next##lnk_ = (afxLinkage*)NIL, *_curr##lnk_ = (ch_)->dummy.next; _next##lnk_ = (_curr##lnk_)->next, lnk_ = (type_*)AfxContainerOf(_curr##lnk_, type_, offset_), (_curr##lnk_) != &(ch_)->dummy; _curr##lnk_ = _next##lnk_)
#define AfxChainForEveryLinkageB2F(ch_, type_, offset_, lnk_) for (afxLinkage *_last##lnk_ = (afxLinkage*)NIL, *_curr##lnk_ = (ch_)->dummy.prev; _last##lnk_ = (_curr##lnk_)->prev, lnk_ = (type_*)AfxContainerOf(_curr##lnk_, type_, offset_), (_curr##lnk_) != &(ch_)->dummy; _curr##lnk_ = _last##lnk_)
