...
_AVX void AfxGetCameraMatrices(afxCamera cam, afxM4d v, afxM4d iv)
{
...
_AVX void AfxGetCameraProjectiveMatrices(afxCamera cam, afxM4d p, afxM4d ip)
{
    afxError err = AFX_ERR_NONE;
    AfxAssertObjects(1, &cam, afxFcc_CAM);
...
_AVX void AfxGetCameraOffset(afxCamera cam, afxV3d offset)
{
    afxError err = AFX_ERR_NONE;
    AfxAssertObjects(1, &cam, afxFcc_CAM);
...
_AVX void AfxSetCameraOffset(afxCamera cam, afxV3d const offset)
{
    afxError err = AFX_ERR_NONE;
    AfxAssertObjects(1, &cam, afxFcc_CAM);
...
_AVX void AfxApplyCameraOffset(afxCamera cam, afxV3d const offset)
{
    afxError err = AFX_ERR_NONE;
    AfxAssertObjects(1, &cam, afxFcc_CAM);
...
_AVX void AfxGetCameraElevAzimRoll(afxCamera cam, afxV3d elevAzimRoll)
{
    afxError err = AFX_ERR_NONE;
    AfxAssertObjects(1, &cam, afxFcc_CAM);
...
_AVX void AfxSetCameraElevAzimRoll(afxCamera cam, afxV3d const elevAzimRoll)
{
    afxError err = AFX_ERR_NONE;
    AfxAssertObjects(1, &cam, afxFcc_CAM);
...
_AVX void AfxApplyCameraElevAzimRoll(afxCamera cam, afxV3d const elevAzimRoll)
{
    afxError err = AFX_ERR_NONE;
    AfxAssertObjects(1, &cam, afxFcc_CAM);
...
_AVX void AfxGetCameraPosition(afxCamera cam, afxV4d point)
{
    afxError err = AFX_ERR_NONE;
    AfxAssertObjects(1, &cam, afxFcc_CAM);
    AfxAssert(point);
...
_AVX void AfxGetCameraLeft(afxCamera cam, afxV3d left)
{
    afxError err = AFX_ERR_NONE;
    AfxAssertObjects(1, &cam, afxFcc_CAM);
    AfxAssert(left);
...
_AVX void AfxGetCameraRight(afxCamera cam, afxV3d right)
{
    afxError err = AFX_ERR_NONE;
    AfxAssertObjects(1, &cam, afxFcc_CAM);
    AfxAssert(right);
...
_AVX void AfxGetCameraUp(afxCamera cam, afxV3d up)
{
    afxError err = AFX_ERR_NONE;
    AfxAssertObjects(1, &cam, afxFcc_CAM);
    AfxAssert(up);
...
_AVX void AfxGetCameraDown(afxCamera cam, afxV3d down)
{
    afxError err = AFX_ERR_NONE;
    AfxAssertObjects(1, &cam, afxFcc_CAM);
    AfxAssert(down);
...
_AVX void AfxGetCameraForward(afxCamera cam, afxV3d fwd)
{
    afxError err = AFX_ERR_NONE;
    AfxAssertObjects(1, &cam, afxFcc_CAM);
    AfxAssert(fwd);
...
_AVX void AfxGetCameraBack(afxCamera cam, afxV3d back)
{
    afxError err = AFX_ERR_NONE;
    AfxAssertObjects(1, &cam, afxFcc_CAM);
    AfxAssert(back);
...
_AVX void AfxSetCameraAspectRatios(afxCamera cam, afxReal physAspectRatio, afxV2d const screenExtent, afxV2d const windowExtent)
{
    afxError err = AFX_ERR_NONE;
    AfxAssertObjects(1, &cam, afxFcc_CAM);
...
_AVX void AfxApplyCameraMotion(afxCamera cam, afxV3d const motion)
{
    afxError err = AFX_ERR_NONE;
    AfxAssertObjects(1, &cam, afxFcc_CAM);
    AfxAssert(motion);
...
_AVX void AfxComputeCameraMatrices(afxCamera cam, afxM4d v, afxM4d iv)
{
    afxError err = AFX_ERR_NONE;
    AfxAssertObjects(1, &cam, afxFcc_CAM);
    AfxAssert(v);
...
_AVX void AfxFindScreenCoordinates(afxCamera cam, afxV2d const wh, afxV4d const worldPoint, afxV3d screenPoint)
{
    afxError err = AFX_ERR_NONE;
    AfxAssertObjects(1, &cam, afxFcc_CAM);
    AfxAssert(wh);
...
_AVX void AfxGetCameraPickingRay(afxCamera cam, afxV2d const wh, afxV2d const cursor, afxV4d origin, afxV3d normal)
{
    afxError err = AFX_ERR_NONE;
    AfxAssertObjects(1, &cam, afxFcc_CAM);
    AfxAssert(wh);
...
_AVX void AfxComputeCameraRelativePlanarBases(afxCamera cam, afxBool screenOrthogonal, afxV3d const planeNormal, afxV4d const pointOnPlane, afxV3d xBasis, afxV3d yBasis)
{
    afxError err = AFX_ERR_NONE;
    AfxAssertObjects(1, &cam, afxFcc_CAM);
