...
_AFXINL void AfxEncapsulatePoints(afxBox bb, afxNat cnt, afxV4d const v[])
{
    afxError err = AFX_ERR_NONE;
    AfxAssert(bb);
    AfxAssert(v);
...
_AFXINL void AfxEncapsulateSpheres(afxBox bb, afxNat cnt, afxSphere const sph[])
{
    afxError err = AFX_ERR_NONE;
    AfxAssert(bb);
    AfxAssert(sph);
...
_AFXINL void AfxEncapsulateAabbs(afxBox bb, afxNat cnt, afxBox const other[])
{
    afxError err = AFX_ERR_NONE;
    AfxAssert(bb);
    AfxAssert(other);
...
_AFXINL void AfxRecomputeAabb(afxBox bb, afxNat cnt, afxV3d const points[])
{
    afxError err = AFX_ERR_NONE;
    AfxAssert(bb);
    AfxAssert(points);
...
_AFXINL afxNat AfxAabbContainsPoints(afxBox const bb, afxNat cnt, afxV3d const point[])
{
    afxError err = AFX_ERR_NONE;
    AfxAssert(bb);
    AfxAssert(point);
...
_AFXINL void AfxExtractAabbCorner(afxBox const bb, afxNat index, afxV4d corner)
{
    afxError err = AFX_ERR_NONE;
    AfxAssert(bb);
    AfxAssert(corner);
