...
_ARX afxError ArxBuildParallelepipedMesh(arxRenderware rwe, afxV3d whd, afxReal slantX, afxReal slantY, arxMesh* mesh)
{
    afxError err = NIL;
...
_ARX afxError ArxBuildDomeMesh2(arxRenderware rwe, afxReal radius, afxUnit stacks, afxUnit slices, afxBool inv, arxMesh* mesh)
{
    afxError err = NIL;
    AFX_ASSERT_OBJECTS(afxFcc_RWE, 1, &rwe);
    ...
    if (strip)
    {
        ...
        AfxAssembleMeshTopology(rwe, 1, &mshtb, &msht);
...
_ARX afxError ArxBuildCapsuleMesh(arxRenderware rwe, afxReal radius, afxReal height, afxUnit stacks, afxUnit slices, afxUnit cylinderSlices, afxBool inv, arxMesh* mesh)
{
    afxError err = NIL;
    AFX_ASSERT_OBJECTS(afxFcc_RWE, 1, &rwe);
...
_ARX afxError ArxBuildPlaneMesh(arxRenderware rwe, afxUnit gridSizeX, afxUnit gridSizeY, afxReal width, afxReal height, arxMesh* mesh)
{
    afxError err = NIL;
    AFX_ASSERT_OBJECTS(afxFcc_RWE, 1, &rwe);
...
_ARX afxError ArxBuildSphereMesh(arxRenderware rwe, afxReal radius, afxUnit stacks, afxUnit slices, afxBool inv, arxMesh* mesh)
{
    afxError err = NIL;
    AFX_ASSERT_OBJECTS(afxFcc_RWE, 1, &rwe);
...
_ARX afxError ArxBuildTorusMesh(arxRenderware rwe, afxReal innerRadius, afxReal outerRadius, afxUnit sides, afxUnit rings, arxMesh* mesh)
{
    afxError err = NIL;
    AFX_ASSERT_OBJECTS(afxFcc_RWE, 1, &rwe);
    AFX_ASSERT(mesh);
...
_ARX afxError ArxBuildCylinderMesh(arxRenderware rwe, afxReal radius1, afxReal radius2, afxReal len, afxUnit slices, afxUnit stacks, arxMesh* mesh)
{
    afxError err = NIL;
    AFX_ASSERT_OBJECTS(afxFcc_RWE, 1, &rwe);
    AFX_ASSERT(mesh);
...
_ARX afxError ArxBuildBoxMesh(arxRenderware rwe, afxV3d const whd, afxUnit secCnt, arxMesh* mesh)
{
    afxError err = NIL;
    AFX_ASSERT_OBJECTS(afxFcc_RWE, 1, &rwe);
    AFX_ASSERT(mesh);
...
_ARX afxError ArxBuildGridMesh(arxRenderware rwe, afxUnit rows, afxUnit layers, afxReal width, afxReal depth, arxMesh* mesh)
{
