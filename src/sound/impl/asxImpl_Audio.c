...
_ASX afxError _AsxSpu_ResampleI16I16(asxSpu* spu, afxAudio src, afxAudio dst, afxWaveResample const* op)
{
    afxError err = NIL;
...
_ASX afxError _AsxSpu_ResampleF32F32(asxSpu* spu, afxAudio src, afxAudio dst, afxWaveResample const* op)
{
    afxError err = NIL;
...
_ASX afxError _AsxSpu_ResampleF32I16(asxSpu* spu, afxAudio src, afxAudio dst, afxWaveResample const* op)
{
...
_ASX afxError _AsxSpu_ResampleI16F32(asxSpu* spu, afxAudio src, afxAudio dst, afxWaveResample const* op)
{
...
_ASX afxError _AsxSpu_ResampleWave(asxSpu* spu, afxAudio src, afxAudio dst, afxWaveResample const* op)
{
    ...
    if (dst->freq == src->freq && op->dstFreq == op->srcFreq && op->dstFreq == dst->freq && src->fmt == dst->fmt)
    {
        ...
        afxWaveCopy cop;
        _AsxSanitizeWaveInterval(src, &op->src, &cop.src);
        cop.dstBaseChan = op->dst.baseChan;
        cop.dstBaseSamp = op->dst.baseSamp;
        _AsxSanitizeWaveCopy(src, dst, &cop, &cop);

        if (_AsxCopyAudio(src, dst, &cop))
            AfxThrowError();
    ...
    afxInt frames = (src->sampCnt + spu->samplesPerFrame - 1) / spu->samplesPerFrame;  // Round up
    ...
    case asxFormat_S32f:
    {
        ...
        case asxFormat_S32f:
        {
            if (_AsxSpu_ResampleF32F32(spu, src, dst, op))
                AfxThrowError();
            break;
        }
        case asxFormat_S16i:
        case asxFormat_A16i:
        {
            if (_AsxSpu_ResampleF32I16(spu, src, dst, op))
                AfxThrowError();
            break;
        }
    ...
    case asxFormat_A16i:
    {
        ...
        case asxFormat_S32f:
        {
            if (_AsxSpu_ResampleI16F32(spu, src, dst, op))
                AfxThrowError();
            break;
        }
        case asxFormat_S16i:
        case asxFormat_A16i:
        {
            if (_AsxSpu_ResampleI16I16(spu, src, dst, op))
                AfxThrowError();
            break;
        }
        default: AfxThrowError(); break;
...
typedef enum asxNoiseType
{
    asxNoiseType_WHITE, // aka static
    asxNoiseType_
} asxNoiseType;

typedef enum asxWaveType
{
    asxWaveType_SINE,
    asxWaveType_SQUARE,
    asxWaveType_TRIANGLE,
    asxWaveType_SAWTOOTH
} asxWaveType;

_ASX void _AsxGenerateSineWave(afxAudio wav, afxUnit chIdx, afxReal amplitude, afxReal freq, afxReal dur)
...
_ASX void _AsxGenerateSquareWave(afxAudio wav, afxUnit chIdx, afxReal amplitude, afxReal freq, afxReal dur)
...
_ASX void _AsxGenerateTriangleWave(afxAudio wav, afxUnit chIdx, afxReal amplitude, afxReal freq, afxReal dur)
...
_ASX void _AsxGenerateSawtoothWave(afxAudio wav, afxUnit chIdx, afxReal amplitude, afxReal freq, afxReal dur)
...
_ASX void _AsxGenerateWhiteNoise(afxAudio wav, afxUnit chIdx, afxReal amplitude, afxReal freq, afxReal dur)
...
_ASX void _AsxGeneratePinkNoise(afxAudio wav, afxUnit chIdx, afxReal amplitude, afxReal freq, afxReal dur)
...
_ASX void _AsxGenerateBrownianNoise(afxAudio wav, afxUnit chIdx, afxReal amplitude, afxReal freq, afxReal dur)
...
_ASX void _AsxGenerateBlueNoise(afxAudio wav, afxUnit chIdx, afxReal amplitude, afxReal freq, afxReal dur)
...
_ASX void _AsxGenerateVioletNoise(afxAudio wav, afxUnit chIdx, afxReal amplitude, afxReal freq, afxReal dur)
...
_ASX void _AsxGenerateGrayNoise(afxAudio wav, afxUnit chIdx, afxReal amplitude, afxReal freq, afxReal dur)
...
_ASX afxError _AsxFillWave(afxAudio wav, afxWaveInterval const* op, afxReal amplitude, afxReal freq, afxReal period)
{
    afxError err = AFX_ERR_NONE;
    AFX_ASSERT_OBJECTS(afxFcc_WAV, 1, &wav);
    afxUnit sampleRate = wav->freq;
...
_ASX afxError _AsxCopyAudio(afxAudio src, afxAudio dst, afxWaveCopy const* op)
{
    afxError err = AFX_ERR_NONE;

    afxWaveCopy op2;
    _AsxSanitizeWaveCopy(src, dst, op, &op2);
...
_ASX afxError _AsxTransposeAudio(afxAudio src, afxAudio dst, afxWaveCopy const* op)
{
    afxError err = AFX_ERR_NONE;
...
_ASX afxError _AsxDumpAudio(afxAudio wav, afxWaveIo const* op, void* dst)
{
    afxError err = AFX_ERR_NONE;
    AFX_ASSERT_OBJECTS(afxFcc_WAV, 1, &wav);
    AFX_ASSERT(dst);
    ...
    afxWaveIo op2;
    _AsxSanitizeWaveInterval(wav, &op->seg, &op2.seg);
...
_ASX afxError _AsxUpdateAudio(afxAudio wav, afxWaveIo const* op, void const* src)
{
    afxError err = AFX_ERR_NONE;
    AFX_ASSERT_OBJECTS(afxFcc_WAV, 1, &wav);
    AFX_ASSERT(src);
...
_ASX afxError _AsxDownloadAudio(afxAudio wav, afxWaveIo const* op, afxStream iob)
{
    afxError err = AFX_ERR_NONE;
    AFX_ASSERT_OBJECTS(afxFcc_WAV, 1, &wav);
    AFX_ASSERT(iob);
...
_ASX afxError _AsxUploadAudio(afxAudio wav, afxWaveIo const* op, afxStream iob)
{
    afxError err = AFX_ERR_NONE;
    AFX_ASSERT_OBJECTS(afxFcc_WAV, 1, &wav);
    AFX_ASSERT(iob);
