...
_AUX afxError AfxAcquireWidgets(afxSession ses, afxUnit cnt, afxWidgetConfig cfg[], afxWidget widgets[])
{
    afxError err = AFX_ERR_NONE;
    AfxAssertObjects(1, &ses, afxFcc_SES);
...
_AUX afxUnit AfxEnumerateWidgets(afxSession ses, afxUnit first, afxUnit cnt, afxWidget widgets[])
{
    afxError err = AFX_ERR_NONE;
    AfxAssertObjects(1, &ses, afxFcc_SES);
