#ifndef xssCompiler_h
#define xssCompiler_h
...
// This module defines the compiler for Luna. It takes a string of source code
// and lexes, parses, and compiles it. Luna uses a single-pass compiler. It
...
// Compiles [source], a string of Luna source code located in [module], to an
