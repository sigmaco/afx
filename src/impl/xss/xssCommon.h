...
// control how Luna works. Some of these are only used while hacking on Luna
// itself.
//
// This header is *not* intended to be included by code outside of Luna itself.

// Luna pervasively uses the C99 integer types (uint16_t, etc.) along with some
...
// If true, then Luna uses a NaN-tagged double for its core value
...
//
// Defaults to on.
#ifndef LUNA_NAN_TAGGING
  #define LUNA_NAN_TAGGING 1
#endif
...
#ifndef LUNA_COMPUTED_GOTO
  #if defined(_MSC_VER) && !defined(__clang__)
    // No computed gotos in Visual Studio.
    #define LUNA_COMPUTED_GOTO 0
  #else
    #define LUNA_COMPUTED_GOTO 1
  #endif
#endif
...
// corresponding `LUNA_OPT_<name>` define to `0`.
#ifndef LUNA_OPT_META
  #define LUNA_OPT_META 1
#endif

#ifndef LUNA_OPT_RANDOM
  #define LUNA_OPT_RANDOM 1
#endif

// These flags are useful for debugging and hacking on Luna itself. They are not
...
// assertion fails, there is a bug in Luna.
//
