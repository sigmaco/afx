...
_ASX afxError AfxAssembleModelFromXml(arxRenderware rwe, afxXml const* xml, afxUnit elemIdx, arxSkeleton skl, arxModel* model)
{
    ...
    arxModel mdl;
    ArxAssembleModels(rwe, 1, &config, &mdl);
