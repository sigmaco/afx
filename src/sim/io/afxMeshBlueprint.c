...
AFX_DEFINE_STRUCT(asxMeshFactory)
{
...
_ASX afxError AsxCleanUpMeshFactory(asxMeshFactory* mfac)
{
    afxError err = NIL;
    AFX_ASSERT(mfac);
    return err;
...
_ASX afxError AsxSetUpMeshFactory(asxMeshFactory* mfac, afxUnit triCnt, afxUnit mtlCnt, afxUnit biasCnt)
{
    afxError err = NIL;
    AFX_ASSERT(mfac);
    *mfac = (asxMeshFactory) { 0 };
    return err;
}

_ASX afxError AsxAddTriangles(asxMeshFactory* mfac, afxUnit mtlIdx, afxUnit triCnt, afxV3d vertices[][3])
{
    afxError err = NIL;
    AFX_ASSERT(vertices);
    AFX_ASSERT(mfac);
...
_ASX afxError AsxAddMaterial(asxMeshFactory* mfac, afxString const* name, afxUnit* mtlIdx)
{
    afxError err = NIL;
    AFX_ASSERT(mfac);
    return err;
...
_ASX afxError AsxRebuildTriangleNormals(asxMeshFactory* mfac, afxUnit baseTriIdx, afxUnit cnt)
{
    afxError err = NIL;
    AFX_ASSERT(mfac);
    ...
    {
        afxUnit const ia = baseTriIdx + j * ASX_INDICES_PER_TRI + 0;
        afxUnit const ib = baseTriIdx + j * ASX_INDICES_PER_TRI + 1;
        afxUnit const ic = baseTriIdx + j * ASX_INDICES_PER_TRI + 2;
...
_ASX afxError AsxRebuildTriangleTangents(asxMeshFactory* mfac, afxUnit baseTriIdx, afxUnit cnt)
{
    afxError err = NIL;
    AFX_ASSERT(mfac);
    AFX_ASSERT_RANGE(mfac->triCnt, baseTriIdx, cnt);
    ...
    for (afxUnit i = 0; i < triCnt; i++)
    {
        afxUnit const ia = baseTriIdx + i * ASX_INDICES_PER_TRI + 0;
        afxUnit const ib = baseTriIdx + i * ASX_INDICES_PER_TRI + 1;
        afxUnit const ic = baseTriIdx + i * ASX_INDICES_PER_TRI + 2;
...
_ASX afxError AsxRebuildTriangleSkins(asxMeshFactory* mfac, afxUnit baseTriIdx, afxUnit cnt)
{
    afxError err = NIL;
    AFX_ASSERT(mfac);
    AFX_ASSERT_RANGE(mfac->triCnt, baseTriIdx, cnt);
