...
AFX_DEFINE_STRUCT(afxSoundDeviceInfo)
{
    ...
    afxError(*openCb)(afxSoundDevice, afxSoundContext, void** udd, afxUnit invokeNo); // unused if a custom dctx ctor is installed.
    ...
    afxError(*relinkSinCb)(afxSoundDevice, afxSoundContext, afxUnit, afxSoundInput[]);
    ...
    afxError(*relinkSoutCb)(afxSoundDevice, afxSoundContext, afxUnit, afxSoundOutput[]);
...
#endif
{
    ...
    afxError(*waitCb)(afxSoundBridge, afxUnit);
    afxUnit(*submitCb)(afxSoundBridge, asxSubmission const*, afxUnit, asxTracker[]);
    afxUnit(*transferCb)(afxSoundBridge, asxTransference const*, afxUnit, void const*);
    afxUnit(*flushCb)(afxSoundBridge, asxFlush const*, afxUnit, afxSoundOutput[], afxUnit const[]);
};
...
AFX_OBJECT(afxSoundOutput)
{
    ...
    void*               udd; // user-defined data
    afxBool             (*getIddCb)(afxSoundOutput,afxUnit,void*);
