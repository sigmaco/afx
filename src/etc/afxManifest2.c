...
_AFX afxBool AfxGetInitializationBool(afxManifest const* ini, afxString const* page, afxString const* key, afxBool* value)
{
    ...
    if ((rslt = ((rslt = AfxGetInitializationString(ini, page, key, &val)) && (!(AfxIsStringEmpty(&val))))) && ((0 == AfxCompareStringCil(&val, 0, "false", 0)) || (0 == AfxCompareStringCil(&val, 0, "0", 0))))
        *value = FALSE;
    else
        *value = TRUE;
...
_AFX afxBool AfxGetInitializationBoolAt(afxManifest const* ini, afxUnit secIdx, afxString const* key, afxBool* value)
{
    ...
    if ((rslt = ((rslt = AfxGetInitializationStringAt(ini, secIdx, key, &val)) && (!(AfxIsStringEmpty(&val))))) && ((0 == AfxCompareStringCil(&val, 0, "false", 0)) || (0 == AfxCompareStringCil(&val, 0, "0", 0))))
        *value = FALSE;
    else
        *value = TRUE;
