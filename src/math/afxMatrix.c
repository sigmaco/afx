...
_AFXINL void AfxAtm3dCopy(afxAtm3d m, afxAtm3d const in)
{
    afxError err = AFX_ERR_NONE;
    AFX_ASSERT(m);
    AFX_ASSERT(in);
...
_AFXINL void AfxAtm3dCopyM3d(afxAtm3d m, afxM3d const in)
{
    afxError err = AFX_ERR_NONE;
    AFX_ASSERT(m);
    AFX_ASSERT(in);
...
_AFXINL void AfxAtm3dCopyM4d(afxAtm3d m, afxM4d const in)
{
    afxError err = AFX_ERR_NONE;
    AFX_ASSERT(m);
    AFX_ASSERT(in);
