...
_AFXINL void AfxPlaneIntersectPlane(afxPlane a, afxPlane b, afxV4d start, afxV4d end)
{
    ...
    AfxClampV4d(start, LinePoint1, AFX_V4D(AFX_EPSILON, AFX_EPSILON, AFX_EPSILON, AFX_EPSILON), LinePoint1);
    AfxClampV4d(end, LinePoint2, AFX_V4D(AFX_EPSILON, AFX_EPSILON, AFX_EPSILON, AFX_EPSILON), LinePoint2);    
}
