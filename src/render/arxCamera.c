...
_ARXINL void ArxSetCameraAspectRatios(arxCamera cam, afxReal physAspectRatio, afxV2d const screenExtent, afxV2d const windowExtent)
{
...
_ARXINL void ArxGetCameraMatrices(arxCamera cam, afxM4d p, afxM4d pv, afxM4d v, afxM4d ip, afxM4d ipv, afxM4d iv)
{
    afxError err = AFX_ERR_NONE;
    AFX_ASSERT_OBJECTS(afxFcc_CAM, 1, &cam);
...
_ARXINL afxReal ArxGetCameraFov(arxCamera cam)
{
    afxError err = AFX_ERR_NONE;
    AFX_ASSERT_OBJECTS(afxFcc_CAM, 1, &cam);
    return cam->fovY;
...
_ARXINL void ArxGetCameraFrustum(arxCamera cam, afxFrustum* frustum, afxReal* nearClipPlane, afxReal* farClipPlane)
{
    afxError err = AFX_ERR_NONE;
    AFX_ASSERT_OBJECTS(afxFcc_CAM, 1, &cam);
...
_ARXINL void ArxModifyCameraDepthRange(arxCamera cam, avxClipSpaceDepth range, afxReal epsilon)
{
    afxError err = AFX_ERR_NONE;
    AFX_ASSERT_OBJECTS(afxFcc_CAM, 1, &cam);
...
_ARXINL void ArxComputeCameraProjectionMatrices(arxCamera cam, afxM4d p, afxM4d ip)
{
    afxError err = NIL;
    AFX_ASSERT_OBJECTS(afxFcc_CAM, 1, &cam);
...
_ARXINL afxError ArxConsultCameraDisplacement(arxCamera cam, afxV3d const displace, avxBlendOp op, afxV3d displacement)
{
    afxError err = AFX_ERR_NONE;
    AFX_ASSERT_OBJECTS(afxFcc_CAM, 1, &cam);
...
_ARXINL void ArxResetCameraDisplacement(arxCamera cam, afxV3d const displacement)
{
    afxError err = AFX_ERR_NONE;
    AFX_ASSERT_OBJECTS(afxFcc_CAM, 1, &cam);
...
_ARXINL void ArxApplyCameraDistance(arxCamera cam, afxReal distance)
{
    afxError err = AFX_ERR_NONE;
    AFX_ASSERT_OBJECTS(afxFcc_CAM, 1, &cam);
    cam->displacement[2] += distance;
...
_ARXINL afxError ArxConsultCameraOrientation(arxCamera cam, afxV3d const rotation, avxBlendOp op, afxV3d elevAzimRoll)
{
    afxError err = AFX_ERR_NONE;
    AFX_ASSERT_OBJECTS(afxFcc_CAM, 1, &cam);
...
_ARXINL void ArxResetCameraOrientation(arxCamera cam, afxV3d const elevAzimRoll)
{
    afxError err = AFX_ERR_NONE;
    AFX_ASSERT_OBJECTS(afxFcc_CAM, 1, &cam);
...
_ARXINL void ArxGetCameraPosition(arxCamera cam, afxV3d point)
{
    afxError err = AFX_ERR_NONE;
    AFX_ASSERT_OBJECTS(afxFcc_CAM, 1, &cam);
    AFX_ASSERT(point);
...
_ARXINL void ArxResetCameraPosition(arxCamera cam, afxV3d const point)
{
    afxError err = AFX_ERR_NONE;
    AFX_ASSERT_OBJECTS(afxFcc_CAM, 1, &cam);
...
_ARXINL void ArxComputeCameraMatrices(arxCamera cam, afxM4d v, afxM4d iv)
{
    afxError err = AFX_ERR_NONE;
    AFX_ASSERT_OBJECTS(afxFcc_CAM, 1, &cam);
    AFX_ASSERT(v);
...
_ARXINL void ArxRecomputeCameraMatrices(arxCamera cam)
{
    afxError err = AFX_ERR_NONE;
    AFX_ASSERT_OBJECTS(afxFcc_CAM, 1, &cam);
    ...
    if (syncV)
        ArxComputeCameraMatrices(cam, cam->v, cam->iv);

    if (syncP)
        ArxComputeCameraProjectionMatrices(cam, cam->p, cam->ip);
...
_ARXINL void ArxGetCameraPickingRay(arxCamera cam, afxV2d const wh, afxV2d const cursor, afxV4d origin, afxV3d normal)
{
    ...
    ArxGetCameraPosition(cam, origin);
    afxV4d v =
    {
...
_ARX afxError _ArxCamCtorCb(arxCamera cam, void** args, afxUnit invokeNo)
{
    ...
    afxBool nonRh = FALSE;
    ArxModifyCameraDepthRange(cam, avxClipSpaceDepth_NEG_ONE_TO_ONE, AFX_EPSILON);
