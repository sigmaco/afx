...
#ifndef AVX_DRV_SRC
#   ifdef _DEBUG
#       define SGL DLLIMPORT extern 
#       define SGLINL DLLIMPORT EMBED
#   else
#       define SGL DLLIMPORT extern 
#       define SGLINL DLLIMPORT EMBED
#   endif
#else
#   ifdef _DEBUG
#       define _SGL DLLEXPORT
#       define SGL DLLEXPORT extern 
#       define _SGLINL DLLEXPORT INLINE
#       define SGLINL DLLEXPORT EMBED
#   else
#       define _SGL DLLEXPORT
#       define SGL DLLEXPORT extern 
#       define _SGLINL DLLEXPORT INLINE
