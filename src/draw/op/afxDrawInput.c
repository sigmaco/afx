...
_AVX afxClass const* AvxGetSceneClass(afxDrawInput din)
{
    afxError err = AFX_ERR_NONE;
    AFX_ASSERT_OBJECTS(afxFcc_DIN, 1, &din);
...
_AVX afxClass const* AvxGetMeshClass(afxDrawInput din)
{
    afxError err = AFX_ERR_NONE;
    AFX_ASSERT_OBJECTS(afxFcc_DIN, 1, &din);
...
_AVX afxStringBase AvxGetPivotTagStringBase(afxDrawInput din)
{
    afxError err = AFX_ERR_NONE;
    AFX_ASSERT_OBJECTS(afxFcc_DIN, 1, &din);
...
_AVX afxStringBase AvxGetMorphTagStringBase(afxDrawInput din)
{
    afxError err = AFX_ERR_NONE;
    AFX_ASSERT_OBJECTS(afxFcc_DIN, 1, &din);
...
_AVX afxError _AvxDinCtorCb(afxDrawInput din, void** args, afxUnit invokeNo)
{
    ...
    AfxMountClass(&din->mshCls, NIL, classes, &tmpClsConf); // require msht, vtd
