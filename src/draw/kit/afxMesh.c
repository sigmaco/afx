...
AVX afxError AfxAcquireMeshTopology(afxDrawInput din, afxMeshBlueprint const* blueprint, afxMeshTopology* topology);
...
_AVX afxError AfxResetMeshSections(afxMesh msh, afxUnit baseSecIdx, afxUnit cnt, afxMeshSection const sections[])
{
    afxError err = AFX_ERR_NONE;
    AFX_ASSERT_OBJECTS(afxFcc_MSH, 1, &msh);
    AFX_ASSERT_RANGE(msh->secCnt, baseSecIdx, cnt);
...
_AVX afxUnit AfxFindVertexAttributes(afxMesh msh, afxUnit cnt, afxString const usages[], afxUnit indices[])
{
    afxError err = AFX_ERR_NONE;
    AFX_ASSERT_OBJECTS(afxFcc_MSH, 1, &msh);
    AFX_ASSERT(indices);
...
_AVX afxError AfxDescribeVertexAttribute(afxMesh msh, afxUnit attrIdx, afxVertexAttribute* info)
{
    afxError err = AFX_ERR_NONE;
    AFX_ASSERT_OBJECTS(afxFcc_MSH, 1, &msh);
...
_AVX afxError AfxFormatVertexAttribute(afxMesh msh, afxUnit attrIdx, avxFormat fmt, afxVertexFlags flags, afxString const* usage)
{
    afxError err = AFX_ERR_NONE;
    AFX_ASSERT_OBJECTS(afxFcc_MSH, 1, &msh);
    AFX_ASSERT_RANGE(msh->attrCnt, attrIdx, 1);
...
_AVX void* AfxAccessVertexData(afxMesh msh, afxUnit attrIdx, afxUnit morphIdx, afxUnit baseVtx)
{
    afxError err = AFX_ERR_NONE;
    AFX_ASSERT_OBJECTS(afxFcc_MSH, 1, &msh);
...
_AVX afxError AfxInvertVertexData(afxMesh msh, afxUnit attrIdx, afxUnit morphIdx, afxUnit baseVtx, afxUnit vtxCnt)
{
    afxError err = AFX_ERR_NONE;
    AFX_ASSERT_OBJECTS(afxFcc_MSH, 1, &msh);
    AFX_ASSERT_RANGE(msh->morphCnt, morphIdx, 1);
...
_AVX afxError AfxNormalizeVertexData(afxMesh msh, afxUnit attrIdx, afxUnit morphIdx, afxUnit baseVtx, afxUnit vtxCnt)
{
    afxError err = AFX_ERR_NONE;
    AFX_ASSERT_OBJECTS(afxFcc_MSH, 1, &msh);
    AFX_ASSERT_RANGE(msh->morphCnt, morphIdx, 1);
...
_AVX afxError AfxUpdateVertexData(afxMesh msh, afxUnit attrIdx, afxUnit morphIdx, afxUnit baseVtx, afxUnit vtxCnt, void const* src, afxUnit32 srcStride)
{
    afxError err = AFX_ERR_NONE;
    AFX_ASSERT_OBJECTS(afxFcc_MSH, 1, &msh);
    AFX_ASSERT_RANGE(msh->morphCnt, morphIdx, 1);
...
_AVX afxError AfxUploadVertexData(afxMesh msh, afxUnit attrIdx, afxUnit morphIdx, afxUnit baseVtx, afxUnit vtxCnt, afxStream in, afxUnit stride)
{
    afxError err = AFX_ERR_NONE;
    AFX_ASSERT_OBJECTS(afxFcc_MSH, 1, &msh);
    AFX_ASSERT_RANGE(msh->morphCnt, morphIdx, 1);
...
_AVX afxError AfxDownloadVertexData(afxMesh msh, afxUnit attrIdx, afxUnit morphIdx, afxUnit baseVtx, afxUnit vtxCnt, afxStream out, afxUnit stride)
{
    afxError err = AFX_ERR_NONE;
    AFX_ASSERT_OBJECTS(afxFcc_MSH, 1, &msh);
    AFX_ASSERT_RANGE(msh->morphCnt, morphIdx, 1);
...
_AVX afxError _AvxMshCtorCb(afxMesh msh, void** args, afxUnit invokeNo)
{
    ...
    if (!AfxCatalogStrings(AvxGetMorphTagStringBase(din), 1, &blueprint->urn.str, &msh->urn))
        AfxThrowError();
    ...
    else if (mtlCnt != (afxUnit)AfxCatalogStrings(AvxGetPivotTagStringBase(din), mtlCnt, blueprint->materials, msh->materials))
        AfxThrowError();
    ...
    else if (biasCnt != (afxUnit)AfxCatalogStrings(AvxGetPivotTagStringBase(din), biasCnt, blueprint->biases, msh->biasId))
        AfxThrowError();
    ...
    else if (attrCnt != (afxUnit)AfxCatalogStrings(AvxGetPivotTagStringBase(din), attrCnt, blueprint->attrs, msh->attrIds))
        AfxThrowError();
    ...
    else if (morphCnt != (afxUnit)AfxCatalogStrings(AvxGetMorphTagStringBase(din), morphCnt, blueprint->morphTags, msh->morphTags))
        AfxThrowError();
...
#if 0
                if (data && AmxGetVertexAttributeFlags(vtd2, j) & afxVertexUsage_SPATIAL)
                {
                    switch (AmxGetVertexAttributeFormat(vtd2, j))
                    {
...
_AVX afxUnit AfxEnumerateMeshes(afxDrawInput din, afxUnit first, afxUnit cnt, afxMesh meshes[])
{
    afxError err = AFX_ERR_NONE;
    AFX_ASSERT_OBJECTS(afxFcc_DIN, 1, &din);
    afxClass const* cls = AvxGetMeshClass(din);
...
_AVX afxError AfxAssembleMeshes(afxDrawInput din, afxUnit cnt, afxMeshBlueprint const blueprints[], afxMesh meshes[])
{
    ...
    afxClass* cls = (afxClass*)AvxGetMeshClass(din);
    AFX_ASSERT_CLASS(cls, afxFcc_MSH);
