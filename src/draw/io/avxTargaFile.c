...
#if 0
void LoadRLERow(avxTargaFile* tga, afxStream kIst, afxByte* dst, afxUnit uiDestSize)
{
...
_AVX afxError AfxDecodeTargaFile(avxTargaFile const* meta, afxStream in, void* dst)
{
    afxError err = NIL;
