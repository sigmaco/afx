...
ASX afxCmdId        AsxCmdOptimizeVertexCacheEXT(afxContext sctx, arxBuffer vbo, afxSize vtxOffset, afxUnit vtxCnt, arxBuffer ibo, afxSize idxOffset, afxUnit idxCnt, avxTopology top);

// Reorders indices to reduce the number of GPU vertex shader invocations and the pixel overdraw.
ASX afxCmdId        AsxCmdOptimizeVertexOverdrawEXT(afxContext sctx, arxBuffer vbo, afxUnit vtxCnt, afxUnit vtxStride, arxBuffer ibo, afxSize idxOffset, afxUnit idxCnt, arxBuffer dst, afxSize dstBase, afxReal threshold);

// Reorders vertices and changes indices to reduce the amount of GPU memory fetches during vertex processing.
ASX afxCmdId        AsxCmdOptimizeVertexFetchEXT(afxContext sctx, arxBuffer vbo, afxSize vtxOffset, afxUnit vtxSiz, arxBuffer ibo, afxSize idxOffset, afxUnit idxCnt, arxBuffer dstVbo, afxSize dstVboOffset);

// Reduces the number of triangles in the mesh, attempting to preserve mesh appearance as much as possible.
ASX afxCmdId        AsxCmdSimplifyTrianglesEXT(afxContext sctx, arxBuffer ibo, afxSize iboOffset, afxUnit idxCnt, arxBuffer vbo, afxSize vboPosOffset, afxUnit vtxPosStride, afxUnit vtxCnt, afxReal tol, afxFlags flags, arxBuffer dst, afxSize dstOffset);
