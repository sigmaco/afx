...
typedef enum avxBufferFlag
{
    ...
    avxBufferFlag_M     = (avxBufferFlag_R | avxBufferFlag_W),
...
AVX afxSize AvxGetBufferAddress
(
    // The buffer to be queried.
    avxBuffer buf,
...
/*
    The AvxGetBufferFlags() function retrieves the access flags of a buffer. By performing a bitwise operation, 
