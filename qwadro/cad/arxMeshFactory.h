...
ARX afxError            ArxBuildSphereMesh(arxScenario scio, afxReal radius, afxUnit stacks, afxUnit slices, afxBool inv, afxV3d const pivot, arxMesh* mesh);
ARX afxError            ArxBuildCapsuleMesh(arxScenario scio, afxReal radius, afxReal height, afxUnit stacks, afxUnit slices, afxUnit cylinderSlices, afxBool inv, afxV3d const pivot, arxMesh* mesh);
ARX afxError            ArxBuildPlaneMesh(arxScenario scio, afxUnit gridSizeX, afxUnit gridSizeY, afxReal width, afxReal height, afxV3d const pivot, arxMesh* mesh);

ARX afxError            ArxBuildBoxMesh(arxScenario scio, afxV3d const whd, afxV3d const pivot, afxUnit secCnt, arxMesh* mesh);
ARX afxError            ArxBuildDiscMesh(arxScenario scio, afxReal radius, afxUnit secCnt, afxV3d const pivot, arxMesh* mesh);
ARX afxError            ArxBuildGridMesh(arxScenario scio, afxUnit rows, afxUnit layers, afxReal width, afxReal depth, afxV3d const pivot, arxMesh* mesh);

#endif//ARX_MESH_FACTORY_H
