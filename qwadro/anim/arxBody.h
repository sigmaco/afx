...
ARX afxError    ArxAcquireBodies(arxScenario scio, arxModel mdl, afxUnit cnt, arxBody bodies[]);
...
ASX afxUnit         ArxEnumerateBodies(arxScenario scio, afxUnit first, afxUnit cnt, arxBody bodies[]);
ASX afxUnit         ArxInvokeBodies(arxScenario scio, afxUnit first, afxUnit cnt, afxBool(*f)(arxBody, void*), void *udd);
