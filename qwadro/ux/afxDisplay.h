...
typedef enum avxVideoTransform
{
    ...
    avxVideoTransform_MIRROR = AFX_BITMASK(3),

    // Invert pixel grid vertically.
    avxVideoTransform_FLIP = AFX_BITMASK(4),

    // 90 degress rotated + V mirror
    avxVideoTransform_90FV = (avxVideoTransform_90 | avxVideoTransform_FLIP),

    // 90 degrees rotated + H mirror
    avxVideoTransform_90FH = (avxVideoTransform_90 | avxVideoTransform_MIRROR),

    avxVideoTransform_CENTER    = AFX_BITMASK(5)
} avxVideoTransform;
