...
/*
    HID stands for Human Interface Device, a class of devices that allow users to interact with computers and other electronic systems. 
    The HID standard, primarily defined by the USB Implementers Forum, enables devices like keyboards, mice, joysticks, and game 
    controllers to communicate with a computer or other host system in a standardized way.
*/
