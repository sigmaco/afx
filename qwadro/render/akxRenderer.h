...
ARX afxError    ArxAcquireRenderers(arxRenderware rwe, afxUnit cnt, akxRenderer rnd[], akxRendererConfig const config[]);


ARX void        ArxCmdRequestModel(arxRenderware rwe, afxUnit id);
