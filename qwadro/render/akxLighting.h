...
ARX afxError    ArxAcquireDirectionalLights(arxRenderware rwe, afxUnit cnt, afxUnit uid[]);
ARX afxError    ArxAcquireOmniLights(arxRenderware rwe, afxUnit cnt, afxUnit uid[]);
ARX afxError    ArxAcquireSpotLights(arxRenderware rwe, afxUnit cnt, afxUnit uid[]);
